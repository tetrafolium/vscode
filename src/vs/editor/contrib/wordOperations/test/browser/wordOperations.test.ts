...
suite("WordOperations", () => {
	...
	const _cursorWordAccessibilityLeftSelect =
		new CursorWordAccessibilityLeftSelect();
	const _cursorWordAccessibilityRight = new CursorWordAccessibilityRight();
	const _cursorWordAccessibilityRightSelect =
		new CursorWordAccessibilityRightSelect();
	...
	function cursorWordAccessibilityLeft(
		...
		runEditorCommand(
			editor,
			inSelectionMode
				? _cursorWordAccessibilityLeft
				: _cursorWordAccessibilityLeftSelect,
		);
	}
	...
	test("deleteInsideWord - onlyWord: does not delete whitespace before last word", () => {
		withTestCodeEditor(["hello world"], {}, (editor, _) => {
			const model = editor.getModel()!;
