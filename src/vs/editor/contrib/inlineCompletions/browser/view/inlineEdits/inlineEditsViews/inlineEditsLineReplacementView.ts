	...
	implements IInlineEditsView
{
	...
	constructor(
		...
		this.minEditorScrollHeight = derived(this, (reader) => {
			...
			return (
				layout.read(reader).lowerText.bottom +
									...
									n.div({
										...
										style: {
											...
											...rectToProps((reader) =>
												layout
													.read(reader)
													.background.translateX(-contentLeft)
													.withMargin(separatorWidth),
											),
									...
									n.div(
										{
											...
											style: {
												...
												...rectToProps((reader) =>
													layout
														.read(reader)
														.lowerText.translateX(-contentLeft),
												),
