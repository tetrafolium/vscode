...
export class InlineEditsDeletionView
	extends Disposable
	implements IInlineEditsView
{
	...
	private readonly _originalVerticalStartPosition: IObservable<
		number | undefined
	>;
	private readonly _originalVerticalEndPosition: IObservable<
		number | undefined
	>;
		...
		.div(
			...
			derived(this, (reader) => {
				...
				const separatorWidth = this._uiState
					...
					.read(reader);
				const separatorRect = overlayRect.map((rect) =>
