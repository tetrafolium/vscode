...
export class ViewGpuContext extends Disposable {
	...
	private static readonly _decorationCssRuleExtractor =
		new DecorationCssRuleExtractor();
	...
	constructor(
				...
				(e) => {
					if (
						...
						const verticalScrollbarSize =
							configurationService.getValue<IEditorOptions>("editor").scrollbar
		...
		this._register(
			this.configurationService.onDidChangeConfiguration((e) => {
				contentLeft.set(
					context.configuration.options.get(EditorOption.layoutInfo)
						.contentLeft,
					undefined,
				);
			}),
