...
suite("SemanticTokensDto", () => {
	...
	function assertEqualFull(
		actual: IFullSemanticTokensDto,
		expected: IFullSemanticTokensDto,
	): void {
	...
	function assertEqualDelta(
		actual: IDeltaSemanticTokensDto,
		expected: IDeltaSemanticTokensDto,
	): void {
	...
	test("issue #94521: unusual backing array buffer", () => {
		function wrapAndSliceUint8Arry(
			buff: Uint8Array,
			prefixLength: number,
			suffixLength: number,
		): Uint8Array {
