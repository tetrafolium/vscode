...
export function generateTokensCSSForFontMap(
	fontMap: readonly IFontTokenOptions[],
): string {
	const rules: string[] = [];
...
export function classNameForFontTokenDecorations(
	fontFamily: string,
	fontSize: number,
): string {
