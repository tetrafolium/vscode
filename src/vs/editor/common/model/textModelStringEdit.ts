...
export function offsetEditToEditOperations(
	offsetEdit: StringEdit,
	doc: ITextModel,
...
export function offsetEditFromContentChanges(
	contentChanges: readonly IModelContentChange[],
) {
...
export function linesLengthEditFromModelContentChange(
