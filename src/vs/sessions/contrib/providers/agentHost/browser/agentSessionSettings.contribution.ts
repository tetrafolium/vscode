...
} from "./agentSessionSettingsFileSystemProvider.js";
 ...
 */
class AgentSessionSettingsContribution
	extends Disposable
	implements IWorkbenchContribution
{
	...
	constructor(
		...
		const schemaRegistrar = this._register(
		...
		this._register(
			fileService.registerProvider(AGENT_SESSION_SETTINGS_SCHEME, provider),
		);
...
registerWorkbenchContribution2(
	AgentSessionSettingsContribution.ID,
	AgentSessionSettingsContribution,
	WorkbenchPhase.AfterRestored,
);

registerAction2(
	class OpenSessionSettingsAction extends Action2 {
		constructor() {
			super({
