...
import {
	...
	IsolationMode,
} from "../../../changes/common/changes.js";
 ...
 */
export class IsAgentHostSessionContextContribution
	extends Disposable
	implements IWorkbenchContribution
{
	...
	constructor(
		...
		this._register(
			bindContextKey(IsAgentHostSession, contextKeyService, (reader) => {
				const activeSession =
...
const AGENT_HOST_SKILL_BUTTON_ID_PREFIX =
	"workbench.action.agentSessions.runSkill.";
