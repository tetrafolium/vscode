...
import {
	...
	IAgentHostSessionEnumPickerItem,
} from "./agentHostModePicker.js";
import { isWellKnownClaudePermissionModeSchema } from "./agentHostPermissionPickerDelegate.js";

const CLAUDE_PERMISSION_MODE_LEARN_MORE_URL =
...
export class AgentHostClaudePermissionModePicker extends AgentHostSessionEnumPicker {
	...
	protected readonly _telemetryId =
		"NewChatAgentHostClaudePermissionModePicker";
	...
	protected override _handleFooterActionItem(
		item: IAgentHostSessionEnumPickerItem,
	): boolean {
		...
		void this._openerService.open(
			URI.parse(CLAUDE_PERMISSION_MODE_LEARN_MORE_URL),
		);
		return true;
	}
}
