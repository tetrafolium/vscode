...
const TUNNEL_HOST_SHARING_CONTEXT = new RawContextKey<boolean>(
	...
	implements IWorkbenchContribution
{
	...
	constructor(
		...
		this._sharingContext =
			TUNNEL_HOST_SHARING_CONTEXT.bindTo(contextKeyService);
...
registerAction2(
	class ToggleRemoteConnectionsAction extends Action2 {
		constructor() {
			super({
...
registerAction2(
	class ShowTunnelHostOutputAction extends Action2 {
		constructor() {
			super({
