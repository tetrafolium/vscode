...
import {
	isRequestVM,
	isResponseVM,
} from "../../../../workbench/contrib/chat/common/model/chatViewModel.js";
 ...
 */
export const ACTION_ID_BRANCH_CHAT_SESSION =
	"workbench.action.chat.branchChatSession";
...
export class BranchChatSessionAction extends Action2 {
	...
	override async run(
		...
		throw new Error(
			"Branching chat sessions is not yet supported." + modelRef.object.title,
		); // TODO: Implement chat session branching and remove this error
	}
}
