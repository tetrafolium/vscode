...
const agentSessionsViewIcon = registerIcon(
	"chat-sessions-icon",
	Codicon.commentDiscussionSparkle,
	localize("agentSessionsViewIcon", "Icon for Agent Sessions View"),
);
...
registerWorkbenchContribution2(
	SessionsTelemetryContribution.ID,
