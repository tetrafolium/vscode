...
import {
	...
	ActiveSessionHasGitSyncActionRunningContext,
	IsNewChatSessionContext,
	IsPhoneLayoutContext,
} from "../../../common/contextkeys.js";
import { IWorkspaceContextService } from "../../../../platform/workspace/common/workspace.js";

export const SESSIONS_FILES_CONTAINER_ID =
	"workbench.sessions.auxiliaryBar.filesContainer";

const filesViewIcon = registerIcon(
	"sessions-files-view-icon",
	Codicon.files,
	localize2(
...
const filesViewContainer = viewContainerRegistry.registerViewContainer(
	{
		...
		openCommandActionDescriptor: {
			...
			mnemonicTitle: localize(
				{ key: "miFiles", comment: ["&& denotes a mnemonic"] },
				"Fil&&es",
			),
...
registerAction2(
	class extends Action2 {
		...
		async run(accessor: ServicesAccessor) {
			...
			const isSyncActionRunning =
				ActiveSessionHasGitSyncActionRunningContext.bindTo(contextKeyService);
