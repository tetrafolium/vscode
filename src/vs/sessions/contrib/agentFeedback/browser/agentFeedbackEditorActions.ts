...
export const navigatePreviousFeedbackActionId =
	"agentFeedbackEditor.action.navigatePrevious";
export const navigateNextFeedbackActionId =
	"agentFeedbackEditor.action.navigateNext";
export const clearAllFeedbackActionId = "agentFeedbackEditor.action.clearAll";
export const navigationBearingFakeActionId =
	"agentFeedbackEditor.navigation.bearings";
...
export const submitActiveSessionFeedbackActionId =
	"agentFeedbackEditor.action.submitActiveSession";
	...
	override async run(accessor: ServicesAccessor): Promise<void> {
		...
		const activePane =
			...
			editorGroupsService
				...
				.find((g) => g.activeEditorPane)?.activeEditorPane ??
...
export function registerAgentFeedbackEditorActions(): void {
	...
	registerAction2(
		class extends NavigateFeedbackAction {
			constructor() {
				super(false);
			}
		},
