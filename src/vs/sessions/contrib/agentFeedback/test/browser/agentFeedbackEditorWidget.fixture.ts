...
const singleFeedback = [
	createFeedbackComment(
		"f-1",
		"Prefer a clearer variable name on this line.",
		2,
	),
];
...
const groupedFeedback = [
	...
	createFeedbackComment(
		"f-3",
		"Consider documenting why this branch is needed.",
		6,
		8,
	),
];
...
const suggestionMix = [
	createReviewComment(
		"r-3",
		"Prefer using the helper so the intent is explicit.",
		8,
		8,
		reviewSuggestion,
	),
	createFeedbackComment(
		"f-3",
		"Keep the helper name aligned with the domain concept.",
		9,
	),
];
...
const prReviewOnly = [
	createPRReviewComment(
		"pr-1",
		"This variable should be renamed to match our naming conventions.",
		2,
	),
	createPRReviewComment(
		"pr-2",
		"Please add error handling for the edge case when second is zero.",
		7,
		8,
	),
];
...
const allSourcesMixed = [
	...
	createPRReviewComment(
		"pr-1",
		"Our style guide says to use descriptive names here.",
		3,
	),
	createReviewComment("r-1", "This should be extracted into a helper.", 6),
	createPRReviewComment(
		"pr-2",
		"This logic duplicates what we have in utils.ts — consider reusing.",
		8,
		9,
	),
];
