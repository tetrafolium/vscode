...
export const IsNewChatSessionContext = new RawContextKey<boolean>(
	"isNewChatSession",
	true,
);
export const ActiveSessionProviderIdContext = new RawContextKey<string>(
	"activeSessionProviderId",
	"",
	localize("activeSessionProviderId", "The provider ID of the active session"),
);
export const ActiveSessionTypeContext = new RawContextKey<string>(
	"activeSessionType",
	"",
...
export const ActiveSessionHasGitRepositoryContext = new RawContextKey<boolean>(
...
export const SessionIsCreatedContext = new RawContextKey<boolean>(
	"sessionIsCreated",
	false,
	localize(
		"sessionIsCreated",
...
export const SessionIsStickyContext = new RawContextKey<boolean>(
	"sessionIsSticky",
	false,
	localize(
		"sessionIsSticky",
...
export const SessionIsMaximizedContext = new RawContextKey<boolean>(
	"sessionIsMaximized",
	false,
	localize(
		"sessionIsMaximized",
...
export const SessionSupportsMultipleChatsContext = new RawContextKey<boolean>(
...
export const ActiveSessionsContext = new RawContextKey<string>(
	"activeSessions",
	"",
	localize("activeSessions", "The identifier of the active sessions panel"),
);
export const SessionsFocusContext = new RawContextKey<boolean>(
	"sessionsFocus",
	false,
	localize("sessionsFocus", "Whether the sessions part has keyboard focus"),
);
export const SessionsVisibleContext = new RawContextKey<boolean>(
	"sessionsVisible",
	false,
	localize("sessionsVisible", "Whether the sessions part is visible"),
);
export const MultipleSessionsVisibleContext = new RawContextKey<boolean>(
...
export const SessionsWelcomeVisibleContext = new RawContextKey<boolean>(
...
export const SessionWorkspacePickerGroupContext = new RawContextKey<string>(
...
export const SessionsAquariumActiveContext = new RawContextKey<boolean>(
...
export const CanGoBackContext = new RawContextKey<boolean>(
	"sessionsCanGoBack",
	false,
	localize(
		"sessionsCanGoBack",
...
export const CanGoForwardContext = new RawContextKey<boolean>(
...
export const EditorMaximizedContext = new RawContextKey<boolean>(
	"editorMaximized",
	false,
	localize("editorMaximized", "Whether the editor area is maximized"),
);
...
export const IsPhoneLayoutContext = new RawContextKey<boolean>(
