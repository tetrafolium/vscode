...
export class SidebarPart extends AbstractPaneCompositePart {
	static readonly activeViewletSettingsKey =
		"workbench.agentsession.sidebar.activeviewletid";
	static readonly pinnedViewContainersKey =
		"workbench.agentsession.pinnedViewlets2";
	static readonly placeholderViewContainersKey =
		"workbench.agentsession.placeholderViewlets";
	static readonly viewContainersWorkspaceStateKey =
		"workbench.agentsession.viewletsWorkspaceState";
	...
	private createFooter(parent: HTMLElement): void {
		...
		this._register(
			this.footerToolbar.onDidChangeMenuItems(() => {
	...
	override updateStyles(): void {
		...
		if (this.sideBarTitleArea) {
			...
			this.sideBarTitleArea.style.color =
	...
	protected getCompositeBarOptions(): IPaneCompositeBarOptions {
		return {
			...
			viewContainersWorkspaceStateKey:
				SidebarPart.viewContainersWorkspaceStateKey,
			icon: false,
