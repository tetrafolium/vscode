...
export interface IObjectTreeModel<T, TFilterData = void> extends ITreeModel<
	T | null,
	TFilterData,
	T | null
> {
...
export interface IObjectTreeModelSetChildrenOptions<
	T,
	TFilterData,
> extends IIndexTreeModelSpliceOptions<T, TFilterData> {}

export interface IObjectTreeModelOptions<
	T,
	TFilterData,
...
export class ObjectTreeModel<T, TFilterData = void> implements IObjectTreeModel<
	T,
	TFilterData
> {
