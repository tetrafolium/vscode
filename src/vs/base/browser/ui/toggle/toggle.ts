	...
	constructor(opts: IToggleOpts) {
		...
		this._register(
			getBaseLayerHoverDelegate().setupDelayedHover(
				...
				() => ({
					content:
						!isMarkdownString(this._title) && !isHTMLElement(this._title)
							? stripIcons(this._title)
							: this._title,
 ...
 */
export function createToggleActionViewItemProvider(
