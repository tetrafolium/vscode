...
function processUNCHostAllowlist(): Set<string> | undefined {
	...
	return (process as unknown as { uncHostAllowlist?: Set<string> })
		.uncHostAllowlist;
}
...
export function disableUNCAccessRestrictions(): void {
	...
	(process as unknown as { restrictUNCAccess?: boolean }).restrictUNCAccess =
		false;
}
...
export function isUNCAccessRestrictionsDisabled(): boolean {
	...
	return (
		(process as unknown as { restrictUNCAccess?: boolean })
			.restrictUNCAccess === false
	);
}
