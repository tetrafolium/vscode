...
suite("Collections", () => {
	...
	test("equalSets", () => {
		...
		assert.strictEqual(
			collections.equalSets(new Set(["a", "b"]), new Set(["b", "a"])),
			true,
		);
		...
		assert.strictEqual(
			collections.equalSets(new Set(["a"]), new Set(["a", "b"])),
			false,
		);
		assert.strictEqual(
			collections.equalSets(new Set(["a", "b"]), new Set(["a"])),
			false,
		);
		assert.strictEqual(
			collections.equalSets(new Set(["a", "b"]), new Set(["a", "c"])),
			false,
		);
	});
