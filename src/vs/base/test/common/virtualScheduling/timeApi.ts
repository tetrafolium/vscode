...
export interface TimeoutId {
	readonly _timeoutIdBrand: void;
}
export interface IntervalId {
	readonly _intervalIdBrand: void;
}
export interface ImmediateId {
	readonly _immediateIdBrand: void;
}
export type AnimationFrameId = number & {
	readonly _animationFrameIdBrand: void;
};
...
export function captureGlobalTimeApi(): TimeApi {
	return {
		setTimeout: globalThis.setTimeout.bind(
			globalThis,
		) as unknown as TimeApi["setTimeout"],
		clearTimeout: globalThis.clearTimeout.bind(
			globalThis,
		) as unknown as TimeApi["clearTimeout"],
		setInterval: globalThis.setInterval.bind(
			globalThis,
		) as unknown as TimeApi["setInterval"],
		clearInterval: globalThis.clearInterval.bind(
			globalThis,
		) as unknown as TimeApi["clearInterval"],
		setImmediate: globalThis.setImmediate?.bind(
			globalThis,
		) as unknown as TimeApi["setImmediate"],
		clearImmediate: globalThis.clearImmediate?.bind(
			globalThis,
		) as unknown as TimeApi["clearImmediate"],
		requestAnimationFrame: globalThis.requestAnimationFrame?.bind(
			globalThis,
		) as unknown as TimeApi["requestAnimationFrame"],
		cancelAnimationFrame: globalThis.cancelAnimationFrame?.bind(
			globalThis,
		) as unknown as TimeApi["cancelAnimationFrame"],
