...
declare namespace monaco.editor {
	...
	export interface IStandaloneEditorConstructionOptions
		extends IEditorConstructionOptions, IGlobalEditorOptions {
		/**
	...
	export const EditorOptions: {
		...
		doubleClickSelectsBlock: IEditorOption<
	...
	export interface IDiffEditorConstructionOptions
		extends IDiffEditorOptions, IEditorConstructionOptions {
		/**
		 * Place overflow widgets inside an external DOM node.
		 * Defaults to an internal DOM node.
		 */
