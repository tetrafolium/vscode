...
export type LanguageModelToolTelemetryClassification = {
	...
	toolSourceKind: {
		classification: "SystemMetaData";
		purpose: "FeatureInsight";
		comment: "The source kind of the tool.";
	};
};
...
export type LanguageModelToolInvokedClassification =
	LanguageModelToolTelemetryClassification & {
		...
		prepareTimeMs?: {
			...
			comment: "Time spent in prepareToolInvocation method in milliseconds.";
		};
		invocationTimeMs?: {
			classification: "SystemMetaData";
			purpose: "PerformanceAndHealth";
			comment: "Time spent in tool invoke method in milliseconds.";
		};
		owner: "roblourens";
