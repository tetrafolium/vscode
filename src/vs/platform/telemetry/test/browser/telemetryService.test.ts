...
class ErrorTestingSettings {
	...
	public nodeModulePathToRetain: string =
		"node_modules/path/that/shouldbe/retained/names.js:14:15854";
	public anonymizedNodeModulePath: string =
		"<REDACTED: user-file-path>/node_modules/path/that/shouldbe/retained/names.js:14:15854";
	public nodeModuleAsarPathToRetain: string =
		"node_modules.asar/path/that/shouldbe/retained/names.js:14:12354";
	public anonymizedNodeModuleAsarPath: string =
		"<REDACTED: user-file-path>/node_modules.asar/path/that/shouldbe/retained/names.js:14:12354";
	public fullNodeModulePath: string =
		"/Users/username/projects/vscode/node_modules/@xterm/xterm/lib/xterm.js:1:243732";
	public anonymizedFullNodeModulePath: string =
		"<REDACTED: user-file-path>/node_modules/@xterm/xterm/lib/xterm.js:1:243732";
	public fullNodeModuleAsarPath: string =
		"/Users/username/projects/vscode/node_modules.asar/@xterm/xterm/lib/xterm.js:1:376066";
	public anonymizedFullNodeModuleAsarPath: string =
		"<REDACTED: user-file-path>/node_modules.asar/@xterm/xterm/lib/xterm.js:1:376066";
	public extensionPathToRetain: string =
		".vscode/extensions/ms-python.python-2024.0.1/out/extension.js:144:145516";
	public fullExtensionPath: string =
		"/Users/username/.vscode/extensions/ms-python.python-2024.0.1/out/extension.js:144:145516";
	public anonymizedExtensionPath: string =
		"<REDACTED: user-file-path>/.vscode/extensions/ms-python.python-2024.0.1/out/extension.js:144:145516";
	public serverInsidersExtensionPathToRetain: string =
		".vscode-server-insiders/extensions/ms-vscode.remote-server-2024.1.0/out/server.js:99:8888";
	public fullServerInsidersExtensionPath: string =
		"/home/user/.vscode-server-insiders/extensions/ms-vscode.remote-server-2024.1.0/out/server.js:99:8888";
	public anonymizedServerInsidersExtensionPath: string =
		"<REDACTED: user-file-path>/.vscode-server-insiders/extensions/ms-vscode.remote-server-2024.1.0/out/server.js:99:8888";
	public builtinExtensionPathToRetain: string =
		"Resources/app/extensions/git/out/git.js:42:1234";
	public fullBuiltinExtensionPath: string =
		"/Applications/Visual Studio Code.app/Contents/Resources/app/extensions/git/out/git.js:42:1234";
	public anonymizedBuiltinExtensionPath: string =
		"<REDACTED: user-file-path>/Resources/app/extensions/git/out/git.js:42:1234";
...
suite("TelemetryService", () => {
	...
	test("setCommonProperty adds property to all subsequent events", function () {
		...
		assert.strictEqual(
			testAppender.events[0].data["common.copilotTrackingId"],
			undefined,
		);
		assert.strictEqual(
			testAppender.events[1].data["common.copilotTrackingId"],
			"test-tracking-id",
		);
	...
	test(
		...
		sinonTestFn(function (this: any) {
			...
			const personInfoWithSpaces =
				settings.personalInfo.slice(0, 2) +
				" " +
				settings.personalInfo.slice(2);
	...
	test(
		...
		sinonTestFn(function (this: any) {
			...
			assert.notStrictEqual(
				testAppender.events[0].data.callstack.indexOf(
					settings.anonymizedNodeModuleAsarPath,
				),
				-1,
				"bare node_modules.asar path",
			);
			assert.notStrictEqual(
				testAppender.events[0].data.callstack.indexOf(
					settings.anonymizedNodeModulePath,
				),
				-1,
	...
	test(
		...
		sinonTestFn(function (this: any) {
			...
			try {
				...
				assert.notStrictEqual(
					cs.indexOf(settings.anonymizedNodeModuleAsarPath),
					-1,
					"bare node_modules.asar path",
				);
				assert.notStrictEqual(
					cs.indexOf(settings.anonymizedNodeModulePath),
					-1,
					"bare node_modules path",
				);
				assert.notStrictEqual(
					cs.indexOf(settings.anonymizedFullNodeModulePath),
					-1,
					"full node_modules path",
				);
				assert.notStrictEqual(
					cs.indexOf(settings.anonymizedFullNodeModuleAsarPath),
					-1,
					"full node_modules.asar path",
				);
	...
	test(
		"Unexpected Error Telemetry removes PII but preserves extension path",
		sinonTestFn(function (this: any) {
			const origErrorHandler = Errors.errorHandler.getUnexpectedErrorHandler();
			Errors.setUnexpectedErrorHandler(() => {});
			...
			try {
				...
				assert.notStrictEqual(
					testAppender.events[0].data.callstack.indexOf(
						settings.extensionPathToRetain,
					),
					-1,
					"User extension path should be retained",
				);
				assert.notStrictEqual(
					testAppender.events[0].data.callstack.indexOf(
						settings.anonymizedExtensionPath,
					),
					-1,
					"User extension path should be anonymized with preserved extension name",
				);
				// Verify the username is removed
				assert.strictEqual(
					testAppender.events[0].data.callstack.indexOf("/Users/username/"),
					-1,
					"Username should be redacted from extension path",
				);

				// Verify server-insiders extension path is preserved (multi-segment suffix like .vscode-server-insiders)
				assert.notStrictEqual(
					testAppender.events[0].data.callstack.indexOf(
						settings.serverInsidersExtensionPathToRetain,
					),
					-1,
					"Server-insiders extension path should be retained",
				);
				assert.notStrictEqual(
					testAppender.events[0].data.callstack.indexOf(
						settings.anonymizedServerInsidersExtensionPath,
					),
					-1,
					"Server-insiders extension path should be anonymized with preserved extension name",
				);
				// Verify the home directory is removed
				assert.strictEqual(
					testAppender.events[0].data.callstack.indexOf("/home/user/"),
					-1,
					"Home directory should be redacted from server-insiders extension path",
				);

				// Verify built-in extension path is preserved but app folder is redacted
				assert.notStrictEqual(
					testAppender.events[0].data.callstack.indexOf(
						settings.builtinExtensionPathToRetain,
					),
					-1,
					"Built-in extension path should be retained",
				);
				assert.notStrictEqual(
					testAppender.events[0].data.callstack.indexOf(
						settings.anonymizedBuiltinExtensionPath,
					),
					-1,
					"Built-in extension path should be anonymized with preserved extension name",
				);
				...
				assert.strictEqual(
					...
					-1,
					"App path should be redacted from built-in extension path",
				);
	...
	test(
		"Unexpected Error Telemetry removes Windows PII but preserves code path",
		sinonTestFn(function (this: any) {
			const origErrorHandler = Errors.errorHandler.getUnexpectedErrorHandler();
			Errors.setUnexpectedErrorHandler(() => {});
			...
			try {
				...
				const windowsUserPath =
					"c:/Users/bpasero/AppData/Local/Programs/Microsoft%20VS%20Code%20Insiders/resources/app/";
				...
				const windowsError: any = new Error(
				...
				assert.strictEqual(
					testAppender.events[0].data.callstack.indexOf("bpasero"),
					-1,
				);
				assert.strictEqual(
					testAppender.events[0].data.callstack.indexOf("Users"),
					-1,
				);
				assert.strictEqual(
					testAppender.events[0].data.callstack.indexOf("c:/Users"),
					-1,
				);
				// Verify important code path is preserved
				assert.notStrictEqual(
					testAppender.events[0].data.callstack.indexOf(codePath),
					-1,
				);
				assert.notStrictEqual(
					testAppender.events[0].data.callstack.indexOf("out/vs/workbench"),
					-1,
				);
	...
	test(
		"Uncaught Error Telemetry removes Windows PII but preserves code path",
		sinonTestFn(function (this: any) {
			const errorStub = sinon.stub();
			mainWindow.onerror = errorStub;
	...
	test(
		"Unexpected Error Telemetry removes macOS PII but preserves code path",
		sinonTestFn(function (this: any) {
			const origErrorHandler = Errors.errorHandler.getUnexpectedErrorHandler();
			Errors.setUnexpectedErrorHandler(() => {});
			...
			try {
				...
				const macUserPath =
					"Applications/Visual%20Studio%20Code%20-%20Insiders.app/Contents/Resources/app/";
				const codePath = "out/vs/workbench/workbench.desktop.main.js";
				const stack = [
				...
				assert.strictEqual(
					testAppender.events[0].data.callstack.indexOf("Applications/Visual"),
					-1,
				);
				assert.strictEqual(
					testAppender.events[0].data.callstack.indexOf(
	...
	test(
		"Uncaught Error Telemetry removes macOS PII but preserves code path",
		sinonTestFn(function (this: any) {
			const errorStub = sinon.stub();
			mainWindow.onerror = errorStub;
			...
			assert.strictEqual(
				testAppender.events[0].data.callstack.indexOf("Visual%20Studio%20Code"),
				-1,
			);
			// Verify important code path is preserved
			assert.notStrictEqual(
	...
	test(
		"Unexpected Error Telemetry removes Linux PII but preserves code path",
		sinonTestFn(function (this: any) {
			const origErrorHandler = Errors.errorHandler.getUnexpectedErrorHandler();
			Errors.setUnexpectedErrorHandler(() => {});
			...
			try {
				...
				const linuxUserPath =
					"/home/parallels/GitDevelopment/vscode-node-sqlite3-perf/";
				...
				const linuxError: any = new Error(
					`Invalid fake file 'git:${linuxUserPath}index.js.git?{"path":"${linuxUserPath}index.js","ref":""}' (Canceled: Canceled)`,
				);
				...
				assert.strictEqual(
					testAppender.events[0].data.msg.indexOf("parallels"),
					-1,
				);
				assert.strictEqual(
					testAppender.events[0].data.msg.indexOf("/home/parallels"),
					-1,
				);
				assert.strictEqual(
					testAppender.events[0].data.msg.indexOf("GitDevelopment"),
					-1,
				);
				assert.strictEqual(
					testAppender.events[0].data.callstack.indexOf("parallels"),
					-1,
				);
				assert.strictEqual(
					testAppender.events[0].data.callstack.indexOf("/home/parallels"),
					-1,
				);
				// Verify important code path is preserved
				assert.notStrictEqual(
	...
	test(
		"Uncaught Error Telemetry removes Linux PII but preserves code path",
		sinonTestFn(function (this: any) {
			const errorStub = sinon.stub();
			mainWindow.onerror = errorStub;
			...
			const linuxError: any = new Error(
				`Unable to read file 'git:${linuxUserPath}index.js.git'`,
			);
			linuxError.stack = stack.join("\n");
	...
	test(
		"Unexpected Error Telemetry strips web origin but preserves path in web stack traces when piiPaths includes origin",
		sinonTestFn(function (this: any) {
			const origErrorHandler = Errors.errorHandler.getUnexpectedErrorHandler();
			Errors.setUnexpectedErrorHandler(() => {});
			...
			try {
				...
				assert.strictEqual(
					cs.indexOf(webOrigin),
					-1,
					"Web origin should be stripped",
				);
				assert.strictEqual(
					cs.indexOf("https://"),
					-1,
					"HTTPS scheme should be stripped",
				);
				// Verify the bundle path is preserved for debugging
				assert.notStrictEqual(
					cs.indexOf(bundlePath),
					-1,
					"Bundle path should be preserved",
				);
