...
export interface IWorkbenchObjectTreeOptionsUpdate<
	T,
> extends IAbstractTreeOptionsUpdate<T> {
	readonly overrideStyles?: IStyleOverride<IListStyles>;
}

export interface IWorkbenchObjectTreeOptions<T, TFilterData>
	extends
		IObjectTreeOptions<T, TFilterData>,
		IWorkbenchObjectTreeOptionsUpdate<T>,
		IResourceNavigatorOptions {
...
> extends ObjectTree<T, TFilterData> {
	...
	override updateOptions(
		options: IWorkbenchObjectTreeOptionsUpdate<T | null> = {},
	): void {
		super.updateOptions(options);
...
export interface IWorkbenchCompressibleObjectTreeOptionsUpdate<
	T,
> extends ICompressibleObjectTreeOptionsUpdate<T> {
	readonly overrideStyles?: IStyleOverride<IListStyles>;
}
...
> extends CompressibleObjectTree<T, TFilterData> {
	...
	override updateOptions(
		options: IWorkbenchCompressibleObjectTreeOptionsUpdate<T | null> = {},
	): void {
		super.updateOptions(options);
...
export interface IWorkbenchDataTreeOptions<T, TFilterData>
	extends
		IWorkbenchDataTreeOptionsUpdate<T>,
...
> {
	...
	override updateOptions(
		options: IWorkbenchDataTreeOptionsUpdate<T | null> = {},
	): void {
		super.updateOptions(options);
...
export interface IWorkbenchAsyncDataTreeOptions<T, TFilterData>
	extends
		IWorkbenchAsyncDataTreeOptionsUpdate<T>,
...
> extends AsyncDataTree<TInput, T, TFilterData> {
	...
	override updateOptions(
		options: IWorkbenchAsyncDataTreeOptionsUpdate<IAsyncDataTreeNode<
			TInput,
			T
		> | null> = {},
	): void {
...
export interface IWorkbenchCompressibleAsyncDataTreeOptions<T, TFilterData>
	extends
		ICompressibleAsyncDataTreeOptions<T, TFilterData>,
		IResourceNavigatorOptions {
	readonly accessibilityProvider: IListAccessibilityProvider<T>;
	readonly overrideStyles?: IStyleOverride<IListStyles>;
	readonly selectionNavigation?: boolean;
...
> extends CompressibleAsyncDataTree<TInput, T, TFilterData> {
	...
	override updateOptions(
		options: ICompressibleAsyncDataTreeOptionsUpdate<IAsyncDataTreeNode<
			TInput,
			T
		> | null>,
	): void {
...
>(
	...
	return {
		...
		options: {
			...
			defaultFindMode:
				options.defaultFindMode ?? getDefaultTreeFindMode(configurationService),
			defaultFindMatchType:
				options.defaultFindMatchType ??
