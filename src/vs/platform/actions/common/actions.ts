...
export class MenuId {
	...
	static readonly ModalEditorTitleContext = new MenuId(
		"ModalEditorTitleContext",
	);
	...
	static readonly EditorRenderWhitespaceSubmenu = new MenuId(
		"EditorRenderWhitespaceSubmenu",
	);
	...
	static readonly NotificationsCenterPositionMenu = new MenuId(
		"NotificationsCenterPositionMenu",
	);
	...
	static readonly SCMArtifactGroupContext = new MenuId(
	...
	static readonly ChatEditingSessionChangesToolbar = new MenuId(
		"ChatEditingSessionChangesToolbar",
	);
	static readonly ChatEditingSessionTitleToolbar = new MenuId(
		"ChatEditingSessionTitleToolbar",
	);
	static readonly ChatEditingSessionChangesVersionsSubmenu = new MenuId(
		"ChatEditingSessionChangesVersionsSubmenu",
	);
	static readonly ChatEditingSessionChangesFileHeaderToolbar = new MenuId(
		"ChatEditingSessionChangesFileHeaderToolbar",
	);
	static readonly ChatEditingSessionChangesFileHeaderRightToolbar = new MenuId(
		"ChatEditingSessionChangesFileHeaderRightToolbar",
	);
	...
	static readonly ChatMessageCheckpoint: MenuId = new MenuId(
		"ChatMessageCheckpoint",
	);
	static readonly ChatMessageRestoreCheckpoint: MenuId = new MenuId(
	...
	static readonly ChatEditorInlineExecute = new MenuId(
		"ChatEditorInputExecute",
	);
	static readonly ChatEditorInlineInputSide = new MenuId("ChatEditorInputSide");
	static readonly InlineChatEditorAffordance = new MenuId(
	...
	static readonly BrowserNavigationToolbar = new MenuId(
	...
	static readonly BrowserEmulationToolbar = new MenuId(
		"BrowserEmulationToolbar",
	);
	static readonly AgentSessionsViewerFilterSubMenu = new MenuId(
		"AgentSessionsViewerFilterSubMenu",
	);
	static readonly AgentSessionsContext = new MenuId("AgentSessionsContext");
	static readonly AgentSessionSectionContext = new MenuId(
		"AgentSessionSectionContext",
	);
	static readonly AgentSessionsCreateSubMenu = new MenuId(
		"AgentSessionsCreateSubMenu",
	);
	static readonly AgentSessionsToolbar = new MenuId("AgentSessionsToolbar");
	static readonly AgentSessionItemToolbar = new MenuId(
		"AgentSessionItemToolbar",
	);
	static readonly AgentSessionSectionToolbar = new MenuId(
		"AgentSessionSectionToolbar",
	);
	static readonly SessionItemContextMenu = new MenuId("SessionItemContextMenu");
	static readonly AgentsTitleBarControlMenu = new MenuId(
		"AgentsTitleBarControlMenu",
	);
	static readonly AgentsChangesToolbar = new MenuId("AgentsChangesToolbar");
	static readonly AgentsChangesPrimaryActionSubMenu = new MenuId(
		"AgentsChangesPrimaryActionSubMenu",
	);
	static readonly AgentsChangeInlineToolbar = new MenuId(
		"AgentsChangeInlineToolbar",
	);
	static readonly ChatViewSessionTitleNavigationToolbar = new MenuId(
		"ChatViewSessionTitleNavigationToolbar",
	);
	static readonly ChatViewSessionTitleToolbar = new MenuId(
		"ChatViewSessionTitleToolbar",
	);
	static readonly ChatContextUsageActions = new MenuId(
		"ChatContextUsageActions",
	);
	static readonly MarkerHoverStatusBar = new MenuId(
		"MarkerHoverParticipant.StatusBar",
	);
