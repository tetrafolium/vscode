	...
	implements IServerChannel<TContext>
{
	...
	private readonly _onCloseEmitter = this._register(
		new Emitter<ICloseSessionEvent>(),
	);
	private readonly _onReloadEmitter = this._register(
		new Emitter<IReloadSessionEvent>(),
	);
	private readonly _onTerminateEmitter = this._register(
		new Emitter<ITerminateSessionEvent>(),
	);
	private readonly _onAttachEmitter = this._register(
		new Emitter<IAttachSessionEvent>(),
	);
