...
} from "../../browser/quickInputUtils.js";
...
suite("QuickInputUtils", () => {
	...
	suite("quickInputButtonsToActionArrays", () => {
		test("should convert empty array", () => {
			...
			const result = quickInputButtonsToActionArrays(
				buttons,
				"prefix",
				() => {},
			);
		...
		test("should trigger callback with correct button", () => {
			const button1: IQuickInputButton = {
				iconClass: "icon1",
				tooltip: "Button 1",
			};
			const button2: IQuickInputButton = {
				iconClass: "icon2",
				tooltip: "Button 2",
			};
		...
		test("should use correct id prefix", () => {
			...
			const result1 = quickInputButtonsToActionArrays(
				buttons,
				"custom-prefix",
				() => {},
			);
			...
			const result2 = quickInputButtonsToActionArrays(
				buttons,
				"another",
				() => {},
			);
