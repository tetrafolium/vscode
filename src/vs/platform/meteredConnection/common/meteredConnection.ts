...
export const IMeteredConnectionService =
	createDecorator<IMeteredConnectionService>("meteredConnectionService");
 ...
 */
export abstract class AbstractMeteredConnectionService
	extends Disposable
