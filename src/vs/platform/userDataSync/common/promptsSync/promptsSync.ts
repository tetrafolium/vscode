 ...
 */
export class PromptsSynchronizer
	...
	implements IUserDataSynchroniser
{
	...
	protected async generateSyncPreview(
		...
		const remotePrompts: IStringDictionary<string> | null =
	...
	protected async applyResult(
		...
		const accptedResourcePreviews: IPromptsAcceptedResourcePreview[] =
	...
	private getResourcePreviews(
		...
		const resourcePreviews: Map<string, IPromptsResourcePreview> = new Map<
			string,
			IPromptsResourcePreview
		>();
	...
	private toPromptContents(
		fileContents: IStringDictionary<IFileContent>,
	...
	private async getPromptsFileContents(): Promise<
	...
	> {
		...
		for (const entry of stat.children || []) {
			...
			if (
				[".prompt.md", ".instructions.md", ".chatmode.md", ".agent.md"].some(
