...
suite("Size Registry", () => {
	...
	test("asCssVariableName should convert identifier to CSS variable name", () => {
		...
		assert.strictEqual(
			asCssVariableName("corner.radius"),
			"--vscode-corner-radius",
		);
		assert.strictEqual(
			asCssVariableName("font.size.large"),
	...
	test("asCssVariable should create CSS variable reference", () => {
		...
		assert.strictEqual(
			asCssVariable("cornerRadius"),
			"var(--vscode-cornerRadius)",
		);
	});
