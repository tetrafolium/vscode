...
suite("serverUrls", () => {
	...
	test("formats IPv6 websocket URLs with brackets", () => {
		...
		assert.deepStrictEqual(
			resolveServerUrls("0000:0000:0000:0000:0000:0000:0000:0001", 8081),
			{
	...
	test("treats wildcard binding as localhost plus network urls", () => {
		assert.deepStrictEqual(
			resolveServerUrls("0.0.0.0", 8081, {
				lo0: [
					{
						address: "127.0.0.1",
						netmask: "255.0.0.0",
		...
		assert.deepStrictEqual(
			resolveServerUrls("0000:0000:0000:0000:0000:0000:0000:0000", 8081, {
				lo0: [
					{
						address: "127.0.0.1",
						netmask: "255.0.0.0",
