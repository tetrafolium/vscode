...
export const IAgentHostCheckpointService =
	createDecorator<IAgentHostCheckpointService>("agentHostCheckpointService");
 ...
 */
export function buildCheckpointRefName(
