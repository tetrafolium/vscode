 ...
 * @category Turn Types
 */
export interface MessageResourceAttachment
	extends MessageAttachmentBase, ContentRef {
	/** Discriminant */
 ...
 * @category Tool Call Types
 */
export interface ToolCallPendingConfirmationState
	extends ToolCallBase, ToolCallParameterFields {
...
export interface ToolCallPendingResultConfirmationState
	extends ToolCallBase, ToolCallParameterFields, ToolCallResult {
 ...
 * @category Tool Call Types
 */
export interface ToolCallCancelledState
	extends ToolCallBase, ToolCallParameterFields {
