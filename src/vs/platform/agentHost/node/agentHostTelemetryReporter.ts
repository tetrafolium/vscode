...
export type IAgentHostUserMessageSentClassification = {
	provider: {
		...
		comment: "The provider handling the agent host session.";
	};
	agentSessionId: {
		classification: "SystemMetaData";
		purpose: "FeatureInsight";
		comment: "The agent host session identifier.";
	};
	source: {
		classification: "SystemMetaData";
		purpose: "FeatureInsight";
		comment: "Whether the user message was sent directly or from the queued-message flow.";
	};
	isSubagentSession: {
		classification: "SystemMetaData";
		purpose: "FeatureInsight";
		isMeasurement: true;
		comment: "Whether the message was sent to a subagent session.";
	};
	turnCount: {
		classification: "SystemMetaData";
		purpose: "FeatureInsight";
		isMeasurement: true;
		comment: "The number of completed turns in the session when the message was sent.";
	};
	activeClientId?: {
		classification: "SystemMetaData";
		purpose: "FeatureInsight";
		comment: "The active client identifier for the session, if any.";
	};
	activeClientToolCount?: {
		classification: "SystemMetaData";
		purpose: "FeatureInsight";
		isMeasurement: true;
		comment: "The number of tools provided by the active client, if any.";
	};
	activeClientCustomizationCount?: {
		classification: "SystemMetaData";
		purpose: "FeatureInsight";
		isMeasurement: true;
		comment: "The number of customizations provided by the active client, if any.";
	};
	attachmentCount: {
		classification: "SystemMetaData";
		purpose: "FeatureInsight";
		isMeasurement: true;
		comment: "The number of attachments included with the user message.";
	};
	owner: "roblourens";
...
export class AgentHostTelemetryReporter {
	...
	userMessageSent(
		...
		this._telemetryService.publicLog2<
			IAgentHostUserMessageSentEvent,
			IAgentHostUserMessageSentClassification
		>("agentHost.userMessageSent", {
			...
			...(activeClient
				? {
						...
						activeClientCustomizationCount:
							activeClient.customizations?.length ?? 0,
					}
				: {}),
			attachmentCount,
		});
