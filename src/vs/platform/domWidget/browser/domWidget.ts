...
export abstract class DomWidget extends Disposable {
	 ...
	 */
	public static instantiateInContents<
	 ...
	 * The observable will change when hot module replacement occurs.
	 */
	public static instantiateObservable<
		TArgs extends unknown[],
		T extends DomWidget,
	>(
		this: DomWidgetCtor<TArgs, T>,
	...
	public static registerWidgetHotReplacement(
		this: new (...args: any[]) => DomWidget,
		id: string,
	): void {
		if (!isHotReloadEnabled()) {
			return;
...
const hotReloadedWidgets = new Map<
	string,
	ISettableObservable<new (...args: any[]) => DomWidget>
>();
