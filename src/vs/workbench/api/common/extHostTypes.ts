...
export {
	...
	SymbolKind,
	SymbolTag,
} from "./extHostTypes/symbolInformation.js";
...
export class ChatSessionCustomizationType {
	...
	static readonly Instructions = new ChatSessionCustomizationType(
		"instructions",
	);
...
export class ChatSessionChangedFile {
	constructor(
		public readonly uri: vscode.Uri,
		public readonly originalUri: vscode.Uri | undefined,
		public readonly modifiedUri: vscode.Uri | undefined,
...
export class LanguageModelDataPart implements vscode.LanguageModelDataPart2 {
	...
	constructor(
		data: Uint8Array<ArrayBufferLike>,
		mimeType: string,
		audience?: vscode.LanguageModelPartAudience[],
	) {
		this.mimeType = mimeType;
		this.data = data;
