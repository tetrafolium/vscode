...
function toGitRepositoryState(
	dto: GitRepositoryStateDto | undefined,
): GitRepositoryState {
	return {
		HEAD: dto?.HEAD
			? ({
...
export class MainThreadGitExtensionService
	extends Disposable
	implements MainThreadGitExtensionShape, IGitExtensionDelegate
{
