...
} from "../../contrib/browserView/common/browserView.js";
...
export class MainThreadBrowsers
	extends Disposable
	implements MainThreadBrowsersShape
{
	private readonly _proxy: ExtHostBrowsersShape;

	private readonly _cdpSessions = this._register(
		new DisposableMap<string, { groupId: string } & IDisposable>(),
	);
	...
	constructor(
		...
		this._register(
			this.browserViewService.onDidChangeBrowserViews(() => {
				for (const editor of this.browserViewService
