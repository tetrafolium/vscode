...
class WebviewFindAccessibilityHelpProvider
	extends Disposable
	implements IAccessibleViewContentProvider
{
	...
	provideContent(): string {
		...
		// Header
		content.push(
			localize("webview.header", "Accessibility Help: Webview Find"),
		);
		content.push(
			localize(
				"webview.context",
		...
		content.push(
			localize("webview.statusDesc", "You are searching the web content."),
		);
		content.push("");
		...
		// Focus Behavior
		content.push(
			localize("webview.focusHeader", "Focus Behavior (Important):"),
		);
		content.push(
			localize(
				"webview.focusDesc1",
		...
		content.push(
			localize("webview.keyboardHeader", "Keyboard Navigation Summary:"),
		);
		content.push("");
		content.push(
			localize("webview.keyNavHeader", "While focused IN the Find input:"),
		);
		content.push(
			localize(
				"webview.keyEnter",
		...
		content.push(
			localize("webview.importantHeader", "Important About Webviews:"),
		);
		content.push(
			localize(
