...
const terminalConfiguration: IStringDictionary<IConfigurationPropertySchema> = {
	...
	[TerminalSettingId.DefaultLocation]: {
		type: "string",
		enum: [
			TerminalLocationConfigValue.Editor,
...
Registry.as<IConfigurationMigrationRegistry>(
...
).registerConfigurationMigrations([
	{
		...
		migrateFn: (value: unknown, valueAccessor) => {
			...
			if (
				valueAccessor(TerminalContribSettingId.AgentSandboxEnabled) ===
				undefined
			) {
				configurationKeyValuePairs.push([
					TerminalContribSettingId.AgentSandboxEnabled,
					{ value: value ? "on" : "off" },
				]);
			}
			configurationKeyValuePairs.push([
				TerminalContribSettingId.DeprecatedAgentSandboxEnabled,
				{ value: undefined },
			]);
	...
	},
	{
		...
		migrateFn: (
			...
			if (
				value !== undefined &&
				valueAccessor(TerminalContribSettingId.AgentSandboxLinuxFileSystem) ===
					undefined
			) {
				configurationKeyValuePairs.push([
					TerminalContribSettingId.AgentSandboxLinuxFileSystem,
					{ value },
				]);
			}
			configurationKeyValuePairs.push([
	...
	},
	{
		...
		migrateFn: (
			...
			if (
				value !== undefined &&
				valueAccessor(TerminalContribSettingId.AgentSandboxMacFileSystem) ===
					undefined
			) {
				configurationKeyValuePairs.push([
					TerminalContribSettingId.AgentSandboxMacFileSystem,
					{ value },
				]);
			}
			configurationKeyValuePairs.push([
				TerminalContribSettingId.DeprecatedAgentSandboxMacFileSystem,
				{ value: undefined },
			]);
			return configurationKeyValuePairs;
		},
