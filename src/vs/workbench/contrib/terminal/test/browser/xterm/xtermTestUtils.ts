...
export class TestWebglAddon implements WebglAddon {
	...
	private readonly _onRemoveTextureAtlasCanvas =
		new Emitter<HTMLCanvasElement>();
	private readonly _onContextLoss = new Emitter<void>();
	readonly onChangeTextureAtlas = this._onChangeTextureAtlas
		.event as IEvent<HTMLCanvasElement>;
	readonly onAddTextureAtlasCanvas = this._onAddTextureAtlasCanvas
		.event as IEvent<HTMLCanvasElement>;
	readonly onRemoveTextureAtlasCanvas = this._onRemoveTextureAtlasCanvas
		.event as IEvent<HTMLCanvasElement, void>;
