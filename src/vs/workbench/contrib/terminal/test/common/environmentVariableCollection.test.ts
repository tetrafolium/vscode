...
suite("EnvironmentVariable - MergedEnvironmentVariableCollection", () => {
	...
	suite("ctor", () => {
		test("Should keep entries that come after a Prepend or Append type mutators", () => {
			...
			deepStrictEqual(
				[...merged.getVariableMap(undefined).entries()],
				[
					[
						"A",
						[
		...
		test("Workspace scoped description entries are properly filtered for each extension", () => {
					...
					[
						"ext1",
						{
							...
							descriptionMap: deserializeEnvironmentDescriptionMap([
								[
									"A-key-scope1",
									{ description: "ext1 scope1 description", scope: scope1 },
								],
								[
									"A-key-scope2",
									{ description: "ext1 scope2 description", scope: scope2 },
								],
							]),
						},
					],
					...
					[
						"ext3",
						{
							...
							descriptionMap: deserializeEnvironmentDescriptionMap([
								[
									"A-key",
									{ description: "ext3 scope2 description", scope: scope2 },
								],
							]),
						},
					],
			...
			deepStrictEqual(
				[...merged.getDescriptionMap(undefined).entries()],
