...
suite("toISCMHistoryItemViewModelArray", () => {
	...
	test("graph with incoming/outgoing changes (remote ref first)", () => {
		...
		assert.strictEqual(viewModels[4].inputSwimlanes.length, 2);
		assert.strictEqual(
			viewModels[4].inputSwimlanes[0].id,
			SCMIncomingHistoryItemId,
		);
		assert.strictEqual(
			viewModels[4].inputSwimlanes[0].color,
		...
		assert.strictEqual(viewModels[4].outputSwimlanes.length, 2);
		assert.strictEqual(
			viewModels[4].outputSwimlanes[0].id,
			SCMIncomingHistoryItemId,
		);
		assert.strictEqual(
			viewModels[4].outputSwimlanes[0].color,
		...
		assert.strictEqual(viewModels[5].inputSwimlanes.length, 2);
		assert.strictEqual(
			viewModels[5].inputSwimlanes[0].id,
			SCMIncomingHistoryItemId,
		);
		assert.strictEqual(
			viewModels[5].inputSwimlanes[0].color,
		...
		assert.strictEqual(
			viewModels[7].inputSwimlanes[0].color,
			historyItemRemoteRefColor,
		);
		...
		assert.strictEqual(
			viewModels[7].outputSwimlanes[0].color,
			historyItemRemoteRefColor,
		);
	});
	...
	test("graph with incoming/outgoing changes (local ref first)", () => {
		...
		assert.strictEqual(
			viewModels[4].outputSwimlanes[1].id,
			SCMIncomingHistoryItemId,
		);
		assert.strictEqual(
			viewModels[4].outputSwimlanes[1].color,
		...
		assert.strictEqual(
			viewModels[5].inputSwimlanes[1].id,
			SCMIncomingHistoryItemId,
		);
		assert.strictEqual(
			viewModels[5].inputSwimlanes[1].color,
