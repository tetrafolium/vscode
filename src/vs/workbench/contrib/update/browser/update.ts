...
export class ProductContribution implements IWorkbenchContribution {
	...
	constructor(
		...
		hostService.hadLastFocus().then(async (hadLastFocus) => {
			...
			const shouldShowPostInstallInfo = configurationService.getValue<boolean>(
	...
	implements IWorkbenchContribution
{
	...
	constructor(
		...
		this.majorMinorUpdateAvailableContextKey =
			MAJOR_MINOR_UPDATE_AVAILABLE.bindTo(contextKeyService);
...
export class DefaultAccountUpdateContribution
	extends Disposable
	implements IWorkbenchContribution
{
