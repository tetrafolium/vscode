...
export class PromptDocumentSemanticTokensProvider implements DocumentSemanticTokensProvider {
	 ...
	 */
	public readonly _debugDisplayName: string =
	...
	provideDocumentSemanticTokens(
		...
		const ordered = [...variableReferences].sort((a, b) =>
		...
		for (const ref of ordered) {
			...
			const length =
				ref.range.endColumn - ref.range.startColumn + extraCharCount;
