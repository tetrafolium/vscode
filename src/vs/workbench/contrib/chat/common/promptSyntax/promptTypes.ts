...
export const INSTRUCTIONS_DOCUMENTATION_URL =
	"https://aka.ms/vscode-ghcp-custom-instructions";
export const AGENT_DOCUMENTATION_URL =
	"https://aka.ms/vscode-ghcp-custom-chat-modes"; // todo
...
export function getPromptsTypeForLanguageId(
	languageId: string,
