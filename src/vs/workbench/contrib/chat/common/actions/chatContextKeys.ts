...
export namespace ChatContextKeys {
	export const responseVote = new RawContextKey<string>(
	...
	export const responseDetectedAgentCommand = new RawContextKey<boolean>(
	...
	export const responseSupportsIssueReporting = new RawContextKey<boolean>(
	...
	export const responseIsFiltered = new RawContextKey<boolean>(
	...
	export const responseHasError = new RawContextKey<boolean>(
	...
	export const requestInProgress = new RawContextKey<boolean>(
	...
	export const hasActiveRequest = new RawContextKey<boolean>(
	...
	export const currentlyEditing = new RawContextKey<boolean>(
	...
	export const currentlyEditingInput = new RawContextKey<boolean>(
	...
	export const editingRequestType = new RawContextKey<
		EditingRequestType | undefined
	>("chatEditingSentRequest", undefined, {
		type: "string",
		description: localize(
	...
	export const isResponse = new RawContextKey<boolean>("chatResponse", false, {
		type: "boolean",
		description: localize("chatResponse", "The chat item is a response."),
	});
	export const isRequest = new RawContextKey<boolean>("chatRequest", false, {
		type: "boolean",
		description: localize("chatRequest", "The chat item is a request"),
	});
	export const isFirstRequest = new RawContextKey<boolean>(
		"chatFirstRequest",
		false,
		{
			type: "boolean",
	...
	export const isPendingRequest = new RawContextKey<boolean>(
	...
	export const itemId = new RawContextKey<string>("chatItemId", "", {
		type: "string",
		description: localize("chatItemId", "The id of the chat item."),
	});
	export const lastItemId = new RawContextKey<string[]>("chatLastItemId", [], {
		type: "string",
		description: localize("chatLastItemId", "The id of the last chat item."),
	});

	export const editApplied = new RawContextKey<boolean>(
		"chatEditApplied",
		false,
		{
			type: "boolean",
	...
	export const inputHasSendableContent = new RawContextKey<boolean>(
		"chatInputHasSendableContent",
		false,
		{
			type: "boolean",
			description: localize(
	...
	export const inputHasFocus = new RawContextKey<boolean>(
		"chatInputHasFocus",
		false,
		{
			type: "boolean",
	...
	export const inChatInput = new RawContextKey<boolean>("inChatInput", false, {
		type: "boolean",
		description: localize(
			"inInteractiveInput",
	...
	export const inChatSession = new RawContextKey<boolean>("inChat", false, {
		type: "boolean",
		description: localize(
			"inChat",
	...
	export const inChatQuestionCarousel = new RawContextKey<boolean>(
	...
	export const chatQuestionCarouselHasTerminal = new RawContextKey<boolean>(
	...
	export const inChatEditor = new RawContextKey<boolean>(
		"inChatEditor",
		false,
		{
			type: "boolean",
	...
	export const inChatTodoList = new RawContextKey<boolean>(
		"inChatTodoList",
		false,
		{
			type: "boolean",
	...
	export const inChatTip = new RawContextKey<boolean>("inChatTip", false, {
		type: "boolean",
		description: localize("inChatTip", "True when focus is in a chat tip."),
	});
	export const multipleChatTips = new RawContextKey<boolean>(
		"multipleChatTips",
		false,
		{
			type: "boolean",
	...
	export const inChatTerminalToolOutput = new RawContextKey<boolean>(
	...
	export const chatModeKind = new RawContextKey<ChatModeKind>(
		"chatAgentKind",
		ChatModeKind.Ask,
		{
			type: "string",
			description: localize("agentKind", "The 'kind' of the current agent."),
		},
	);
	export const chatPermissionLevel = new RawContextKey<ChatPermissionLevel>(
		"chatPermissionLevel",
	...
	export const chatModeName = new RawContextKey<string>("chatModeName", "", {
		type: "string",
		description: localize(
			"chatModeName",
	...
	export const chatModelId = new RawContextKey<string>("chatModelId", "", {
		type: "string",
		description: localize(
			"chatModelId",
	...
	export const supported = ContextKeyExpr.or(
		IsWebContext.negate(),
		RemoteNameContext.notEqualsTo(""),
		ContextKeyExpr.has("config.chat.experimental.serverlessWebEnabled"),
	);
	export const enabled = new RawContextKey<boolean>("chatIsEnabled", false, {
		type: "boolean",
		description: localize(
			"chatIsEnabled",
	 ...
	 */
	export const lockedToCodingAgent = new RawContextKey<boolean>(
		"lockedToCodingAgent",
		false,
		{
			type: "boolean",
	...
	export const lockedCodingAgentId = new RawContextKey<string>(
		"lockedCodingAgentId",
		"",
		{
			type: "string",
	 ...
	 */
	export const chatSessionHasCustomAgentTarget = new RawContextKey<boolean>(
	 ...
	 */
	export const chatSessionHasTargetedModels = new RawContextKey<boolean>(
	...
	export const agentSupportsAttachments = new RawContextKey<boolean>(
	...
	export const withinEditSessionDiff = new RawContextKey<boolean>(
	...
	export const filePartOfEditSession = new RawContextKey<boolean>(
	...
	export const extensionParticipantRegistered = new RawContextKey<boolean>(
	...
	export const panelParticipantRegistered = new RawContextKey<boolean>(
	...
	export const chatEditingCanUndo = new RawContextKey<boolean>(
		"chatEditingCanUndo",
		false,
		{
			type: "boolean",
	...
	export const chatEditingCanRedo = new RawContextKey<boolean>(
		"chatEditingCanRedo",
		false,
		{
			type: "boolean",
	...
	export const languageModelsAreUserSelectable = new RawContextKey<boolean>(
	...
	export const nonCopilotLanguageModelsAreUserSelectable =
		new RawContextKey<boolean>("chatNonCopilotModelsAreUserSelectable", false, {
			type: "boolean",
			description: localize(
	...
	export const chatSessionHasModels = new RawContextKey<boolean>(
	...
	export const chatSessionOptionsValid = new RawContextKey<boolean>(
	...
	export const extensionInvalid = new RawContextKey<boolean>(
	...
	export const inputCursorAtTop = new RawContextKey<boolean>(
		"chatCursorAtTop",
		false,
	);
	export const inputHasAgent = new RawContextKey<boolean>(
		"chatInputHasAgent",
		false,
	);
	export const location = new RawContextKey<ChatAgentLocation>(
		"chatLocation",
		undefined,
	);
	export const inQuickChat = new RawContextKey<boolean>(
		"quickChatHasFocus",
		false,
		{
			type: "boolean",
	...
	export const inAgentSessionsWelcome = new RawContextKey<boolean>(
	...
	export const chatSessionType = new RawContextKey<string>(
		"chatSessionType",
		"",
		{
			type: "string",
	...
	export const hasFileAttachments = new RawContextKey<boolean>(
	...
	export const chatSessionIsEmpty = new RawContextKey<boolean>(
		"chatSessionIsEmpty",
		true,
		{
			type: "boolean",
	...
	export const hasPendingRequests = new RawContextKey<boolean>(
	...
	export const chatSessionHasDebugData = new RawContextKey<boolean>(
	...
	export const chatSessionHasDebugTools = new RawContextKey<boolean>(
	...
	export const remoteJobCreating = new RawContextKey<boolean>(
	...
	export const hasRemoteCodingAgent = new RawContextKey<boolean>(
	...
	export const hasCanDelegateProviders = new RawContextKey<boolean>(
	...
	export const enableRemoteCodingAgentPromptFileOverlay =
	...
	export const skipChatRequestInProgressMessage = new RawContextKey<boolean>(
	...
	export const completionsQuotaExceeded =
		ChatEntitlementContextKeys.completionsQuotaExceeded;

	export const Editing = {
		hasToolConfirmation: new RawContextKey<boolean>(
		...
		hasElicitationRequest: new RawContextKey<boolean>(
		...
		hasQuestionCarousel: new RawContextKey<boolean>(
	...
	export const Tools = {
		toolsCount: new RawContextKey<number>("toolsCount", 0, {
			type: "number",
			description: localize(
				"toolsCount",
	...
	export const foregroundSessionCount = new RawContextKey<number>(
	...
	export const Modes = {
		hasCustomChatModes: new RawContextKey<boolean>(
			"chatHasCustomAgents",
			false,
			{
				type: "boolean",
		...
		agentModeDisabledByPolicy: new RawContextKey<boolean>(
	...
	export const panelLocation = new RawContextKey<ViewContainerLocation>(
		"chatPanelLocation",
		undefined,
		{
			type: "number",
	...
	export const agentSessionsViewerFocused = new RawContextKey<boolean>(
	...
	export const agentSessionsViewerOrientation = new RawContextKey<number>(
	...
	export const agentSessionsViewerPosition = new RawContextKey<number>(
	...
	export const agentSessionsViewerVisible = new RawContextKey<boolean>(
	...
	export const agentSessionType = new RawContextKey<string>(
		"chatSessionType",
		"",
		{
			type: "string",
	...
	export const chatSessionSupportsDelegation = new RawContextKey<boolean>(
	...
	export const chatSessionSupportsFork = new RawContextKey<boolean>(
	...
	export const agentSessionSection = new RawContextKey<string>(
		"agentSessionSection",
		"",
		{
			type: "string",
	...
	export const isArchivedAgentSession = new RawContextKey<boolean>(
	...
	export const isPinnedAgentSession = new RawContextKey<boolean>(
	...
	export const isReadAgentSession = new RawContextKey<boolean>(
		"agentSessionIsRead",
		false,
		{
			type: "boolean",
	...
	export const hasMultipleAgentSessionsSelected = new RawContextKey<boolean>(
	...
	export const hasAgentSessionChanges = new RawContextKey<boolean>(
	...
	export const isKatexMathElement = new RawContextKey<boolean>(
	 ...
	 */
	export const hasUsedCreateSlashCommands = new RawContextKey<boolean>(
	...
	export const contextUsageHasBeenOpened = new RawContextKey<boolean>(
	...
	export const newChatButtonExperimentIcon = new RawContextKey<string>(
...
export namespace ChatContextKeyExprs {
	...
	export const isAgentHostSession = ContextKeyExpr.or(
		ContextKeyExpr.regex(
			ChatContextKeys.lockedCodingAgentId.key,
			/^agent-host-/,
		),
