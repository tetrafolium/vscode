...
import {
	...
	agentToMarkdown,
} from "./widget/chatContentParts/chatMarkdownDecorationsRenderer.js";
import { IWorkbenchEnvironmentService } from "../../../services/environment/common/environmentService.js";
import { ContextKeyExpr } from "../../../../platform/contextkey/common/contextkey.js";
import {
	AICustomizationManagementCommands,
	AICustomizationManagementSection,
} from "./aiCustomization/aiCustomizationManagement.js";
...
export class ChatSlashCommandsContribution extends Disposable {
	...
	constructor(
		...
		const setPermissionLevelForSession = (
			sessionResource: URI,
		...
		const autoApprovePolicyValue = configurationService.inspect<boolean>(
							...
							agents
								...
								.map(async (a) => {
									...
									const agentMarkdown = instantiationService.invokeFunction(
										(accessor) =>
											agentToMarkdown(a, sessionResource, true, accessor),
									);
...
export class ChatSessionOptionSlashCommandsContribution extends Disposable {
	...
	private readonly _registrationsByType = this._register(
	...
	private refreshForSessionType(chatSessionType: string): void {
		...
		const groups =
			this.chatSessionsService.getOptionGroupsForSessionType(chatSessionType);
