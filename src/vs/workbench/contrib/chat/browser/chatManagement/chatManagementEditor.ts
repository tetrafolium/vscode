...
export class ModelsManagementEditor extends EditorPane {
	...
	constructor(
		...
		this.inModelsEditorContextKey =
			CONTEXT_MODELS_EDITOR.bindTo(contextKeyService);
	}
	...
	override async setInput(
		input: ModelsManagementEditorInput,
	...
	override layout(dimension: Dimension): void {
		...
		if (this.bodyContainer) {
			this.modelsWidget?.layout(
				dimension.height - 15,
				this.bodyContainer!.clientWidth - 24,
			);
		}
	}
