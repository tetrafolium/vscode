 ...
 */
export const AICustomizationManagementTitleMenuId = MenuId.for(
	"AICustomizationManagementEditorTitle",
);

/**
 * Menu ID for the AI Customization Management Editor item context menu.
 */
export const AICustomizationManagementItemMenuId = MenuId.for(
	"AICustomizationManagementEditorItem",
);
 ...
 */
export const AICustomizationManagementCreateMenuId = MenuId.for(
	"AICustomizationManagementCreate",
);
