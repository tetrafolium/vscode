		...
		const tree = this.instantiationService.createInstance(
			...
			new ChatListTreeDataSource(),
			{
				...
				accessibilityProvider: {
					getAriaLabel: (element: IChatResponseProgressFileTreeData) =>
						element.label,
...
class ChatListTreeRenderer implements ICompressibleTreeRenderer<
	IChatResponseProgressFileTreeData,
	void,
...
class ChatListTreeDataSource implements IAsyncDataSource<
	IChatResponseProgressFileTreeData,
	IChatResponseProgressFileTreeData
> {
