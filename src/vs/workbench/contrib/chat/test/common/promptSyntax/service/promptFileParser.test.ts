...
suite("PromptFileParser", () => {
	...
	test("agent", async () => {
		...
		assert.deepEqual(result.header.range, {
			startLineNumber: 2,
			startColumn: 1,
			endLineNumber: 5,
			endColumn: 1,
		...
		assert.deepEqual(result.header.attributes, [
			{
				key: "description",
				range: new Range(2, 1, 2, 26),
				value: {
					type: "scalar",
					value: "Agent test",
					range: new Range(2, 14, 2, 26),
					format: "double",
				},
			},
			{
				key: "model",
				range: new Range(3, 1, 3, 15),
				value: {
					type: "scalar",
					value: "GPT 4.1",
					range: new Range(3, 8, 3, 15),
					format: "none",
				},
			},
			{
					...
					items: [
						{
							type: "scalar",
							value: "tool1",
							range: new Range(4, 9, 4, 16),
							format: "single",
						},
						{
							type: "scalar",
							value: "tool2",
							range: new Range(4, 18, 4, 25),
							format: "single",
						},
					],
		...
		assert.deepEqual(result.body.fileReferences, [
			{
				range: new Range(7, 99, 7, 114),
				content: "./reference1.md",
				isMarkdownLink: false,
			},
			{
				range: new Range(7, 140, 7, 155),
				content: "./reference2.md",
				isMarkdownLink: true,
			},
		]);
		assert.deepEqual(result.body.variableReferences, [
			{
				range: new Range(7, 17, 7, 22),
				name: "tool1",
				offset: 108,
				fullLength: 11,
			},
			{
				range: new Range(7, 79, 7, 85),
				name: "tool-2",
				offset: 170,
				fullLength: 12,
			},
		...
		assert.equal(
			content.substring(ref1.offset, ref1.offset + ref1.fullLength),
			"#tool:tool1",
		);
		assert.equal(
			content.substring(ref2.offset, ref2.offset + ref2.fullLength),
			"#tool:tool-2",
		);
							...
							properties: [
								{
									key: {
										type: "scalar",
										value: "label",
										range: new Range(5, 5, 5, 10),
										format: "none",
									},
									value: {
										type: "scalar",
										value: "Implement",
										range: new Range(5, 12, 5, 23),
										format: "double",
									},
								},
								{
									key: {
										type: "scalar",
										value: "agent",
										range: new Range(6, 5, 6, 10),
										format: "none",
									},
									value: {
										type: "scalar",
										value: "Default",
										range: new Range(6, 12, 6, 19),
										format: "none",
									},
								},
								{
									key: {
										type: "scalar",
										value: "prompt",
										range: new Range(7, 5, 7, 11),
										format: "none",
									},
									value: {
										type: "scalar",
										value: "Implement the plan",
										range: new Range(7, 13, 7, 33),
										format: "double",
									},
								},
								{
									key: {
										type: "scalar",
										value: "send",
										range: new Range(8, 5, 8, 9),
										format: "none",
									},
									value: {
										type: "scalar",
										value: "false",
										range: new Range(8, 11, 8, 16),
										format: "none",
									},
								},
							],
							...
							properties: [
								{
									key: {
										type: "scalar",
										value: "label",
										range: new Range(9, 5, 9, 10),
										format: "none",
									},
									value: {
										type: "scalar",
										value: "Save",
										range: new Range(9, 12, 9, 18),
										format: "double",
									},
								},
								{
									key: {
										type: "scalar",
										value: "agent",
										range: new Range(10, 5, 10, 10),
										format: "none",
									},
									value: {
										type: "scalar",
										value: "Default",
										range: new Range(10, 12, 10, 19),
										format: "none",
									},
								},
								{
									key: {
										type: "scalar",
										value: "prompt",
										range: new Range(11, 5, 11, 11),
										format: "none",
									},
									value: {
										type: "scalar",
										value: "Save the plan to a file",
										range: new Range(11, 13, 11, 38),
										format: "double",
									},
								},
								{
									key: {
										type: "scalar",
										value: "send",
										range: new Range(12, 5, 12, 9),
										format: "none",
									},
									value: {
										type: "scalar",
										value: "true",
										range: new Range(12, 11, 12, 15),
										format: "none",
									},
								},
							],
	...
	test("instructions", async () => {
		...
		assert.deepEqual(result.header.attributes, [
			{
				key: "description",
				range: new Range(2, 1, 2, 54),
				value: {
					type: "scalar",
					value: "Code style instructions for TypeScript",
					range: new Range(2, 14, 2, 54),
					format: "double",
				},
			},
			{
				key: "applyTo",
				range: new Range(3, 1, 3, 14),
				value: {
					type: "scalar",
					value: "*.ts",
					range: new Range(3, 10, 3, 14),
					format: "none",
				},
			},
		]);
		...
		assert.deepEqual(result.body.fileReferences, [
			{
				range: new Range(5, 64, 5, 103),
				content: "https://mycomp/guidelines#typescript.md",
				isMarkdownLink: true,
			},
		]);
		assert.deepEqual(result.body.variableReferences, []);
		assert.deepEqual(
			...
			"Code style instructions for TypeScript",
		);
	...
	test("prompt file", async () => {
		...
		assert.deepEqual(result.header.attributes, [
			{
				key: "description",
				range: new Range(2, 1, 2, 48),
				value: {
					type: "scalar",
					value: "General purpose coding assistant",
					range: new Range(2, 14, 2, 48),
					format: "double",
				},
			},
			{
				key: "agent",
				range: new Range(3, 1, 3, 13),
				value: {
					type: "scalar",
					value: "agent",
					range: new Range(3, 8, 3, 13),
					format: "none",
				},
			},
			{
				key: "model",
				range: new Range(4, 1, 4, 15),
				value: {
					type: "scalar",
					value: "GPT 4.1",
					range: new Range(4, 8, 4, 15),
					format: "none",
				},
			},
			{
					...
					items: [
						{
							type: "scalar",
							value: "search",
							range: new Range(5, 9, 5, 17),
							format: "single",
						},
						{
							type: "scalar",
							value: "terminal",
							range: new Range(5, 19, 5, 29),
							format: "single",
						},
					],
	...
	test("ignores links and variables inside inline code and fenced code blocks", async () => {
		...
		assert.ok(result.body);
		assert.deepEqual(
			result.body.fileReferences.map((reference) => ({
				content: reference.content,
				isMarkdownLink: reference.isMarkdownLink,
			})),
			[
		...
		assert.deepEqual(
			result.body.variableReferences.map((reference) => reference.name),
			["outside"],
		);
	});
	...
	test("ignores references in multiple inline code spans on the same line", async () => {
		...
		assert.ok(result.body);
		assert.deepEqual(
			result.body.fileReferences.map((r) => ({
				content: r.content,
				isMarkdownLink: r.isMarkdownLink,
			})),
			[{ content: "./real.md", isMarkdownLink: true }],
		);
		assert.deepEqual(
			result.body.variableReferences.map((r) => r.name),
			["visible"],
		);
	});
	...
	suite("parseCommaSeparatedList", () => {
		function assertCommaSeparatedList(
			input: string,
			expected: IScalarValue[],
		): void {
			const actual = parseCommaSeparatedList({
				type: "scalar",
				value: input,
				range: new Range(1, 1, 1, input.length + 1),
				format: "none",
			});
		...
		test("simple unquoted values", () => {
			assertCommaSeparatedList("a, b, c", [
				...
				},
				{
					type: "scalar",
					value: "b",
					range: new Range(1, 4, 1, 5),
					format: "none",
				},
				{
					type: "scalar",
					value: "c",
					range: new Range(1, 7, 1, 8),
					format: "none",
				},
			]);
		});
		...
		test("unquoted values without spaces", () => {
			assertCommaSeparatedList("foo,bar,baz", [
				...
				},
				{
					type: "scalar",
					value: "bar",
					range: new Range(1, 5, 1, 8),
					format: "none",
				},
				{
					type: "scalar",
					value: "baz",
					range: new Range(1, 9, 1, 12),
					format: "none",
				},
			]);
		});
		...
		test("mixed quoted and unquoted values", () => {
			assertCommaSeparatedList("unquoted, \"double\", 'single'", [
				...
				},
				{
					type: "scalar",
					value: "double",
					range: new Range(1, 11, 1, 19),
					format: "double",
				},
				{
					type: "scalar",
					value: "single",
					range: new Range(1, 21, 1, 29),
					format: "single",
				},
			]);
		});
			...
			assert.deepStrictEqual(result.items, [
				{
					type: "scalar",
					value: "a",
					range: new Range(6, 11, 6, 12),
					format: "none",
				},
				{
					type: "scalar",
					value: "b",
					range: new Range(6, 14, 6, 15),
					format: "none",
				},
				{
					type: "scalar",
					value: "c",
					range: new Range(6, 17, 6, 18),
					format: "none",
				},
			]);
		});
	...
	test("userInvocable getter reads user-invocable attribute", async () => {
		...
		const content4 = ["---", 'description: "Test"', "---"].join("\n");
	...
	test("agent with all header fields including colons in description", async () => {
		...
		assert.deepEqual(result.header.tools, [
			"search",
			"read",
			"web",
			"vscode/memory",
		...
		assert.deepEqual(
			result.header.attributes.map((a) => a.key),
			[
				"name",
				"description",
				"argument-hint",
	...
	test("agent with unquoted description containing colon-space", async () => {
		...
		assert.deepEqual(
			result.header.description,
			"This has a colon: in the middle",
		);
		assert.deepEqual(result.header.target, "vscode");
	});
});
