...
export class OpenEditorsView extends ViewPane {
	...
	private handleContextKeys() {
		...
		const openEditorsSelectedFileOrUntitledContext =
			OpenEditorsSelectedFileOrUntitledContext.bindTo(this.contextKeyService);
...
class OpenEditorsDelegate implements IListVirtualDelegate<
	OpenEditor | IEditorGroup
> {
...
class EditorGroupRenderer implements IListRenderer<
	IEditorGroup,
...
class OpenEditorRenderer implements IListRenderer<
	OpenEditor,
...
class OpenEditorsDragAndDrop implements IListDragAndDrop<
	OpenEditor | IEditorGroup
> {
	...
	onDragStart(data: IDragAndDropData, originalEvent: DragEvent): void {
		const items = (data as ElementsDragAndDropData<OpenEditor | IEditorGroup>)
			.elements;
...
class OpenEditorsAccessibilityProvider implements IListAccessibilityProvider<
	OpenEditor | IEditorGroup
> {
