...
export const MOST_RECENT_REPL_EDITOR = new RawContextKey<string>(
...
export const NOTEBOOK_OR_COMPOSITE_IS_ACTIVE_EDITOR = ContextKeyExpr.or(
...
export const NOTEBOOK_CELL_OUTPUT_MIMETYPE = new RawContextKey<string>(
