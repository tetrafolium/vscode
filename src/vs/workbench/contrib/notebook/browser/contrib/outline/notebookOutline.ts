...
class NotebookOutlineRenderer implements ITreeRenderer<
	OutlineEntry,
	FuzzyScore,
...
export class NotebookOutlinePaneProvider implements IDataSource<
	NotebookCellOutline,
	OutlineEntry
> {
	private readonly _disposables = new DisposableStore();
...
export class NotebookOutlineCreator implements IOutlineCreator<
	NotebookEditor,
	OutlineEntry
> {
