...
export const NOTEBOOK_TITLE: ILocalizedString = localize2(
	"notebook.notebookVariables",
	"Notebook Variables",
);
export const REPL_TITLE: ILocalizedString = localize2(
...
export class NotebookVariableAccessibilityProvider implements IListAccessibilityProvider<INotebookVariableElement> {
	private _widgetAriaLabel = observableValue(
		"widgetAriaLabel",
		NOTEBOOK_TITLE.value,
	);
