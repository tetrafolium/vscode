...
export const INotebookOriginalCellModelFactory =
	createDecorator<INotebookOriginalCellModelFactory>(
...
export class OriginalNotebookCellModelReferenceCollection extends ReferenceCollection<ITextModel> {
	...
	protected override createReferencedObject(
		...
		const languageSelection = this._languageService.getLanguageIdByLanguageName(
			language,
		)
