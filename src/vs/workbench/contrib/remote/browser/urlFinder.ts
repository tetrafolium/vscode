...
export class UrlFinder extends Disposable {
	...
	private readonly listeners: Map<ITerminalInstance | string, IDisposable> =
		new Map();
	...
	private replPositions: Map<string, { position: number; tail: IReplElement }> =
		new Map();
