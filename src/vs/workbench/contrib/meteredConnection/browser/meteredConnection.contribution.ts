...
import {
	...
	MeteredConnectionSettingValue,
} from "../../../../platform/meteredConnection/common/meteredConnection.js";
import {
	IQuickInputService,
	IQuickPickItem,
...
registerAction2(
	class ConfigureMeteredConnectionAction extends Action2 {
		...
		override async run(accessor: ServicesAccessor): Promise<void> {
			...
			const picks: (IQuickPickItem & {
				value: MeteredConnectionSettingValue;
			})[] = [
				{
					value: "auto",
