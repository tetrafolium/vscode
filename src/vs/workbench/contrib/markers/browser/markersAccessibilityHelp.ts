...
class ProblemsAccessibilityHelpProvider
	extends Disposable
	implements IAccessibleViewContentProvider
{
	...
	provideContent(): string {
		...
		lines.push(
			nls.localize("problems.statusDesc", "You are filtering the problems."),
		);
		lines.push("");
		...
		lines.push(
			nls.localize("problems.filterHeader", "What Happens When You Filter:"),
		);
		lines.push(
			nls.localize(
		...
		// Focus Behavior
		lines.push(
			nls.localize("problems.focusHeader", "Focus Behavior (Important):"),
		);
		lines.push(
			nls.localize(
				"problems.focusDesc1",
		...
		// Filter Syntax
		lines.push(
			nls.localize("problems.syntaxHeader", "Filter Syntax and Patterns:"),
		);
		lines.push(
			nls.localize(
				"problems.syntaxText",
		...
		lines.push(
			nls.localize("problems.severityHeader", "Severity and Scope Filtering:"),
		);
		lines.push(
			nls.localize(
		...
		lines.push(
			nls.localize("problems.keyboardHeader", "Keyboard Navigation Summary:"),
		);
		lines.push(
			nls.localize(
				"problems.keyDown",
