...
export const PREFERENCES_EDITOR_COMMAND_OPEN =
	"workbench.preferences.action.openPreferencesEditor";
...
export const SETTINGS_EDITOR_COMMAND_SHOW_AI_RESULTS =
	"settings.action.showAIResults";
export const SETTINGS_EDITOR_COMMAND_TOGGLE_AI_SEARCH =
...
export const CONTEXT_KEYBINDINGS_SEARCH_HAS_VALUE = new RawContextKey<boolean>(
...
export const CONTEXT_AI_SETTING_RESULTS_AVAILABLE = new RawContextKey<boolean>(
	"aiSettingResultsAvailable",
	false,
);
