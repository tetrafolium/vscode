...
export namespace TestingContextKeys {
	...
	export const isContinuousModeOn = new RawContextKey<boolean>(
	...
	export const hasCoverageInFile = new RawContextKey(
	...
	export const hasInlineCoverageDetails = new RawContextKey(
