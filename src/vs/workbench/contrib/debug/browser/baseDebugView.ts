...
export const splitExpressionOrScopeHighlights = (
	e: IExpression | IScope,
...
export const expressionAndScopeLabelProvider: IKeyboardNavigationLabelProvider<
	IExpression | IScope
> = {
	getKeyboardNavigationLabel(e) {
		const stripAnsi =
			e.getSession()?.rememberedCapabilities?.supportsANSIStyling;
