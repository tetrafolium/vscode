	...
	implements IAccessibleViewContentProvider
{
	...
	public provideContent(): string {
		...
		// Header
		content.push(
			localize("repl.header", "Accessibility Help: Debug Console Filter"),
		);
		content.push(
			localize(
				"repl.context",
		...
		content.push(
			localize("repl.statusDesc", "You are filtering the console output."),
		);
		content.push("");

		// Inside the Filter Input
		content.push(
			localize("repl.inputHeader", "Inside the Filter Input (What It Does):"),
		);
		content.push(
			localize(
				"repl.inputDesc",
		...
		content.push(
			localize("repl.filterHeader", "What Happens When You Filter:"),
		);
		content.push(
			localize(
				"repl.filterDesc",
		...
		content.push(
			localize("repl.keyboardHeader", "Keyboard Navigation Summary:"),
		);
		content.push(
			localize(
				"repl.keyDown",
