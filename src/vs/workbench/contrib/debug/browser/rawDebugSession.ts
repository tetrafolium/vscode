...
export class RawDebugSession implements IDisposable {
	...
	// DAP events
	private readonly _onDidInitialize = this.toDispose.add(
		new Emitter<DebugProtocol.InitializedEvent>(),
	);
	private readonly _onDidStop = this.toDispose.add(
		new Emitter<DebugProtocol.StoppedEvent>(),
	);
	private readonly _onDidContinued = this.toDispose.add(
		new Emitter<DebugProtocol.ContinuedEvent>(),
	);
	private readonly _onDidTerminateDebugee = this.toDispose.add(
		new Emitter<DebugProtocol.TerminatedEvent>(),
	);
	private readonly _onDidExitDebugee = this.toDispose.add(
		new Emitter<DebugProtocol.ExitedEvent>(),
	);
	private readonly _onDidThread = this.toDispose.add(
		new Emitter<DebugProtocol.ThreadEvent>(),
	);
	private readonly _onDidOutput = this.toDispose.add(
		new Emitter<DebugProtocol.OutputEvent>(),
	);
	private readonly _onDidBreakpoint = this.toDispose.add(
		new Emitter<DebugProtocol.BreakpointEvent>(),
	);
	private readonly _onDidLoadedSource = this.toDispose.add(
		new Emitter<DebugProtocol.LoadedSourceEvent>(),
	);
	private readonly _onDidProgressStart = this.toDispose.add(
		new Emitter<DebugProtocol.ProgressStartEvent>(),
	);
	private readonly _onDidProgressUpdate = this.toDispose.add(
		new Emitter<DebugProtocol.ProgressUpdateEvent>(),
	);
	private readonly _onDidProgressEnd = this.toDispose.add(
		new Emitter<DebugProtocol.ProgressEndEvent>(),
	);
	private readonly _onDidInvalidated = this.toDispose.add(
		new Emitter<DebugProtocol.InvalidatedEvent>(),
	);
	private readonly _onDidInvalidateMemory = this.toDispose.add(
		new Emitter<DebugProtocol.MemoryEvent>(),
	);
	private readonly _onDidCustomEvent = this.toDispose.add(
		new Emitter<DebugProtocol.Event>(),
	);
	private readonly _onDidEvent = this.toDispose.add(
		new Emitter<DebugProtocol.Event>(),
	);

	// DA events
	private readonly _onDidExitAdapter = this.toDispose.add(
		new Emitter<AdapterEndEvent>(),
	);
