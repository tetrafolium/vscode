...
export namespace CommentContextKeys {
	 ...
	 */
	export const activeCursorHasComment = new RawContextKey<boolean>(
	 ...
	 */
	export const commentWidgetVisible = new RawContextKey<boolean>(
	 ...
	 */
	export const commentingEnabled = new RawContextKey<boolean>(
		"commentingEnabled",
		true,
		{
			description: nls.localize(
