...
class TestCommentThread implements CommentThread<IRange> {
	...
	readonly onDidChangeComments: Event<readonly Comment[] | undefined> =
		new Emitter<readonly Comment[] | undefined>().event;
	readonly onDidChangeInitialCollapsibleState: Event<
		CommentThreadCollapsibleState | undefined
	> = new Emitter<CommentThreadCollapsibleState | undefined>().event;
	canReply: boolean = false;
	readonly onDidChangeInput: Event<CommentInput | undefined> = new Emitter<
		CommentInput | undefined
	>().event;
	readonly onDidChangeRange: Event<IRange> = new Emitter<IRange>().event;
	readonly onDidChangeLabel: Event<string | undefined> = new Emitter<
		string | undefined
	>().event;
	readonly onDidChangeCollapsibleState: Event<
		CommentThreadCollapsibleState | undefined
	> = new Emitter<CommentThreadCollapsibleState | undefined>().event;
	readonly onDidChangeState: Event<CommentThreadState | undefined> =
		new Emitter<CommentThreadState | undefined>().event;
