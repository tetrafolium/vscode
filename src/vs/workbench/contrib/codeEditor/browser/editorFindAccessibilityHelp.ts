...
} from "../../../../platform/accessibility/browser/accessibleViewRegistry.js";
 ...
 */
class EditorFindAccessibilityHelpProvider
	extends Disposable
	implements IAccessibleViewContentProvider
{
	...
	constructor(private readonly _findController: CommonFindController) {
		super();
	}
	...
	provideContent(): string {
		...
		if (isReplaceVisible) {
			...
			// Focus Behavior
			content.push(
				localize("replace.focusHeader", "Focus Behavior (Important):"),
			);
			content.push(
				localize(
					"replace.focusDesc1",
			...
			content.push(
				localize("replace.keyboardHeader", "Keyboard Navigation Summary:"),
			);
			content.push("");
			content.push(
				localize(
			...
			content.push(
				localize(
					...
					"<keybinding:editor.action.replaceOne>",
				),
			);
			content.push(
				localize(
					...
					"<keybinding:editor.action.replaceAll>",
				),
			);
			content.push("");
			content.push(
			...
			content.push(
				localize(
					...
					"<keybinding:editor.action.nextMatchFindAction>",
				),
			);
			content.push(
				localize(
					...
					"<keybinding:editor.action.previousMatchFindAction>",
				),
			);
			content.push("");
			content.push(
			...
			content.push(
				localize("find.dialogHeader", "Inside the Find Dialog (What It Does):"),
			);
			content.push(
				localize(
					"find.dialogDesc",
			...
			// Keyboard Navigation Summary
			content.push(
				localize("find.keyboardHeader", "Keyboard Navigation Summary:"),
			);
			content.push("");
			content.push(
				localize("find.keyNavFindHeader", "While focused IN the Find input:"),
			);
			content.push(
				localize(
					"find.keyEnter",
			...
			// Find Options
			content.push(
				localize("find.optionsHeader", "Find Options in the Dialog:"),
			);
			content.push(
				localize(
					"find.optionCase",
			...
			content.push(
				localize(
					"find.settingCloseOnResult",
					"- `editor.find.closeOnResult`: Closes the Find dialog after an explicit find navigation command lands on a match.",
				),
			);
			content.push(
				localize(
