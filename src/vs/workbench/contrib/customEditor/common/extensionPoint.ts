...
export type ICustomEditorsExtensionPoint = TypeFromJsonSchema<
	typeof customEditorsContributionSchema
>;
...
export const customEditorsExtensionPoint =
	ExtensionsRegistry.registerExtensionPoint<ICustomEditorsExtensionPoint[]>({
		...
		activationEventsGenerator: function* (
			contribs: readonly ICustomEditorsExtensionPoint[],
		) {
...
function renderPriority(
	priority: ICustomEditorsExtensionPoint["priority"] | string | undefined,
): string {
	if (!priority) {
		return "";
	}
