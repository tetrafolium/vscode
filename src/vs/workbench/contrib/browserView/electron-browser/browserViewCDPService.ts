...
} from "../../../../platform/browserView/common/browserViewGroup.js";
import { IMainProcessService } from "../../../../platform/ipc/common/mainProcessService.js";
import { IBrowserViewCDPService } from "../common/browserView.js";
import { mainWindow } from "../../../../base/browser/window.js";

export class BrowserViewCDPService
	extends Disposable
	implements IBrowserViewCDPService
{
	...
	async createSessionGroup(browserId: string): Promise<string> {
		const groupId = await this._groupService.createGroup({
