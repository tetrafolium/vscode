...
export const CTX_INLINE_CHAT_HAS_NOTEBOOK_INLINE = new RawContextKey<boolean>(
...
export const CTX_INLINE_CHAT_HAS_NOTEBOOK_AGENT = new RawContextKey<boolean>(
...
export const CTX_INLINE_CHAT_FILE_BELONGS_TO_CHAT = new RawContextKey<boolean>(
...
export const CTX_INLINE_CHAT_TERMINATED = new RawContextKey<boolean>(
...
export const CTX_INLINE_CHAT_AFFORDANCE_VISIBLE = new RawContextKey<boolean>(
...
export const CTX_FIX_DIAGNOSTICS_ENABLED = ContextKeyExpr.equals(
	"config.inlineChat.fixDiagnostics",
	true,
);
export const CTX_ASK_IN_CHAT_ENABLED = ContextKeyExpr.equals(
	"config.inlineChat.askInChat",
	true,
);
