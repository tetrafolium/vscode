	...
	logPrepare(state: {
		...
		type TelemetryClassification = {
			...
			terminalToolSessionId: {
				...
				comment: "The session ID for this particular terminal tool invocation.";
			};

			subCommands: {
				classification: "SystemMetaData";
				purpose: "FeatureInsight";
				comment: "A sanitized list of sub-commands that were executed, encoded as a JSON array";
			};
			autoApproveAllowed: {
				classification: "SystemMetaData";
				purpose: "FeatureInsight";
				comment: "Whether auto-approve was allowed when evaluated";
			};
			autoApproveResult: {
				classification: "SystemMetaData";
				purpose: "FeatureInsight";
				comment: "Whether the command line was auto-approved";
			};
			autoApproveReason: {
				classification: "SystemMetaData";
				purpose: "FeatureInsight";
				comment: "The reason it was auto approved or denied";
			};
			autoApproveDefault: {
				classification: "SystemMetaData";
				purpose: "FeatureInsight";
				isMeasurement: true;
				comment: "Whether the command line was auto approved due to a default rule";
			};
		};

		this._telemetryService.publicLog2<TelemetryEvent, TelemetryClassification>(
			"toolUse.runInTerminal.prepare",
			{
				terminalToolSessionId: state.terminalToolSessionId,
				subCommands: new TelemetryTrustedValue(
					JSON.stringify(subCommandsSanitized),
				),
	...
	logInvoke(
		...
		type TelemetryClassification = {
			...
			isNewSession: {
				...
				purpose: "FeatureInsight";
				isMeasurement: true;
				comment: "Whether this was the first execution for the terminal session";
			};
			isSandbox: {
				classification: "SystemMetaData";
				purpose: "FeatureInsight";
				isMeasurement: true;
				comment: "Whether the command was run inside the terminal sandbox";
			};
			requestUnsandboxedExecutionReason: {
				classification: "SystemMetaData";
				purpose: "FeatureInsight";
				comment: "The reason the model gave for requesting unsandboxed execution, if any";
			};
			outputLineCount: {
				classification: "SystemMetaData";
				purpose: "FeatureInsight";
				isMeasurement: true;
				comment: "How many lines of output were produced, this is -1 when isBackground is true or if there's an error";
			};
			nonZeroExitCode: {
				classification: "SystemMetaData";
				purpose: "FeatureInsight";
				isMeasurement: true;
				comment: "Whether the command exited with a non-zero code (-1=error/unknown, 0=zero exit code, 1=non-zero)";
			};
			exitCodeValue: {
				classification: "SystemMetaData";
				purpose: "PerformanceAndHealth";
				isMeasurement: true;
				comment: "The actual exit code of the terminal command (-1 if unknown)";
			};
			timingConnectMs: {
				classification: "SystemMetaData";
				purpose: "FeatureInsight";
				isMeasurement: true;
				comment: "How long the terminal took to start up and connect to";
			};
			timingExecuteMs: {
				classification: "SystemMetaData";
				purpose: "FeatureInsight";
				isMeasurement: true;
				comment: "How long the terminal took to execute the command";
			};
			pollDurationMs: {
				classification: "SystemMetaData";
				purpose: "FeatureInsight";
				isMeasurement: true;
				comment: "How long the tool polled for output, this is undefined when isBackground is true or if there's an error";
			};
			terminalExecutionIdleBeforeTimeout: {
				classification: "SystemMetaData";
				purpose: "FeatureInsight";
				isMeasurement: true;
				comment: "Indicates whether a terminal became idle before the run-in-terminal tool timed out or was cancelled by the user. This occurs when no data events are received twice consecutively and the model determines, based on terminal output, that the command has completed.";
			};
			...
			inputUserChars: {
				...
				purpose: "FeatureInsight";
				isMeasurement: true;
				comment: "The number of characters the user input manually, a single key stroke could map to several characters. Focus in/out sequences are not counted as part of this";
			};
			inputUserSigint: {
				classification: "SystemMetaData";
				purpose: "FeatureInsight";
				isMeasurement: true;
				comment: "Whether the user input the SIGINT signal";
			};
			...
			inputToolManualChars: {
				...
				purpose: "FeatureInsight";
				isMeasurement: true;
				comment: "The number of characters input by manual acceptance of a suggestion";
			};
			...
			inputToolFreeFormInputCount: {
				...
				purpose: "FeatureInsight";
				isMeasurement: true;
				comment: "The number of times the user entered free form input after prompting";
			};

			compressOutputEnabled: {
				classification: "SystemMetaData";
				purpose: "FeatureInsight";
				isMeasurement: true;
				comment: "Whether the chat.tools.compressOutput.enabled setting is on for this invocation.";
			};
		};
		this._telemetryService.publicLog2<TelemetryEvent, TelemetryClassification>(
			"toolUse.runInTerminal",
			{
				...
				strategy:
					state.shellIntegrationQuality === ShellIntegrationQuality.Rich
						? 2
						: state.shellIntegrationQuality === ShellIntegrationQuality.Basic
							? 1
							: 0,
				...
				requestUnsandboxedExecutionReason:
					state.requestUnsandboxedExecutionReason,
				outputLineCount: state.outputLineCount,
				nonZeroExitCode:
					state.exitCode === undefined ? -1 : state.exitCode === 0 ? 0 : 1,
				...
				terminalExecutionIdleBeforeTimeout:
					state.terminalExecutionIdleBeforeTimeout ?? false,
				...
				inputToolFreeFormInputShownCount:
					state.inputToolFreeFormInputShownCount ?? 0,
