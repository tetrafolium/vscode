...
class TerminalOscNotificationsContribution
	extends Disposable
	implements ITerminalContribution
{
	...
	xtermReady(xterm: IXtermTerminal & { raw: RawXtermTerminal }): void {
		this._register(
			xterm.raw.parser.registerOscHandler(99, (data) =>
				this._handler.handleSequence(data),
			),
		);
	}
}
...
export function getTerminalOscNotifications(
	instance: ITerminalInstance,
): TerminalOscNotificationsContribution | null {
