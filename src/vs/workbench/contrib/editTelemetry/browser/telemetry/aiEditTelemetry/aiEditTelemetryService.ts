...
export const IAiEditTelemetryService = createDecorator<IAiEditTelemetryService>(
...
export interface IEditTelemetryBaseData {
	...
	feature: /** Code suggestions generated in the sidebar chat panel */
		| "sideBarChat"
	...
	presentation: /** Code displayed in a code block within chat responses. Only possible when feature is `sideBarChat` or `inlineChat`. */
		| "codeBlock"
	...
	modeId: /** User asking questions without requesting code changes */
		| "ask"
...
export interface IEditTelemetryCodeAcceptedData extends IEditTelemetryBaseData {
	acceptanceMethod: /** Insert code at the current cursor position in the active editor. Only possible when presentation is `codeBlock`. */
		| "insertAtCursor"
