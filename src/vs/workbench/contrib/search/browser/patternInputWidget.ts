...
export class IncludePatternInputWidget extends PatternInputWidget {
	...
	onChangeSearchInChangedFilesBox =
		this._onChangeSearchInChangedFilesBoxEmitter.event;
	...
	protected override getSubcontrolsWidth(): number {
		return (
			...
			this.useSearchInEditorsBox.width() +
			this.useSearchInChangedFilesBox.width()
		);
	}

	protected override renderSubcontrols(controlsDiv: HTMLDivElement): void {
		this.useSearchInChangedFilesBox = this._register(
			new Toggle({
		...
		this.useSearchInChangedFilesBox.disable();
		this._register(
			this.useSearchInChangedFilesBox.onChange((viaKeyboard) => {
...
export class ExcludePatternInputWidget extends PatternInputWidget {
	...
	protected override getSubcontrolsWidth(): number {
		return (
			super.getSubcontrolsWidth() + this.useExcludesAndIgnoreFilesBox.width()
		);
	}
