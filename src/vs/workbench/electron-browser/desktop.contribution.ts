	...
	registry.registerConfiguration({
		...
		properties: {
			...
			"window.menuStyle": {
				...
				default:
					product.quality !== "stable"
						...
						: isMacintosh
							? "native"
							: "inherit", // TODO@bpasero figure out the default
				scope: ConfigurationScope.APPLICATION,
			...
			"window.border": {
				...
				default: "default",
				markdownDescription: (() => {
					let windowBorderDescription = localize(
	...
	const schema: IJSONSchema = {
		...
		properties: {
			...
			"js-flags": {
				...
				description: localize(
					"argv.jsFlags",
					'Specifies V8 JavaScript engine flags to pass (e.g. "--max-old-space-size=4096"). These flags are applied to the main process, renderer and utility processes.',
				),
			},
		},
	};
