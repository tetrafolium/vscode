...
export class WorkbenchContextKeysHandler extends Disposable {
	...
	constructor(
		...
		this.isSessionsWindowContext = IsSessionsWindowContext.bindTo(
			this.contextKeyService,
		);
		...
		// Automation
		this.inAutomationContext = InAutomationContext.bindTo(
			this.contextKeyService,
		);
		this.inAutomationContext.set(
		...
		this.auxiliaryBarMaximizedContext = AuxiliaryBarMaximizedContext.bindTo(
			this.contextKeyService,
		);
		this.auxiliaryBarMaximizedContext.set(
