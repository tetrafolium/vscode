...
} from "../../platform/workspaces/common/workspaceIdentifier.js";
...
export class BrowserMain extends Disposable {
	...
	private async initServices(): Promise<{
		...
		const configurationService = await this.createWorkspaceAndDependentServices(
			serviceCollection,
			workspace,
			environmentService,
			userDataProfileService,
	...
	private async createWorkspaceAndDependentServices(
		...
		const { configurationService, storageService } =
			await this.createWorkspaceConfigAndStorageServices(
				serviceCollection,
				workspace,
				environmentService,
				userDataProfileService,
