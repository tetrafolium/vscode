	...
	return verifyObject<IEditorPartOptions>(
		{
			...
			showTabIndex: new BooleanVerifier(
				DEFAULT_EDITOR_PART_OPTIONS["showTabIndex"],
			),
			...
			swipeToNavigate: new BooleanVerifier(
				DEFAULT_EDITOR_PART_OPTIONS["swipeToNavigate"],
			),
			...
			allowDropIntoGroup: new BooleanVerifier(
				DEFAULT_EDITOR_PART_OPTIONS["allowDropIntoGroup"],
			),
			...
			titleScrollbarVisibility: new EnumVerifier(
				DEFAULT_EDITOR_PART_OPTIONS["titleScrollbarVisibility"],
				["auto", "visible", "hidden"],
			),
...
export interface IEditorGroupView
	extends IDisposable, ISerializableView, IEditorGroup {
