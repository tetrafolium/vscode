...
class DropOverlay extends Themable {
			...
			new DragAndDropObserver(container, {
				onDragOver: (e) => {
					...
					let splitOnDragAndDrop =
						!!this.groupView.groupsView.partOptions.splitOnDragAndDrop;
	...
	private positionOverlay(
		...
		const preferSplitVertically =
			this.groupView.groupsView.partOptions.openSideBySideDirection === "right";
	...
	private getOverlayOffsetHeight(): number {
		...
		if (
			...
			this.groupView.groupsView.partOptions.showTabs === "multiple"
		) {
