...
MenuRegistry.appendMenuItem(MenuId.EditorSplitMoveSubmenu, {
	command: {
		...
		title: localize("moveAbove", "Move Above"),
	},
	group: "2_move",
	order: 10,
});
MenuRegistry.appendMenuItem(MenuId.EditorSplitMoveSubmenu, {
	command: {
		...
		title: localize("moveBelow", "Move Below"),
	},
	group: "2_move",
	order: 20,
});
MenuRegistry.appendMenuItem(MenuId.EditorSplitMoveSubmenu, {
	command: {
		...
		title: localize("moveLeft", "Move Left"),
	},
	group: "2_move",
	order: 30,
});
MenuRegistry.appendMenuItem(MenuId.EditorSplitMoveSubmenu, {
	command: {
		...
		title: localize("moveRight", "Move Right"),
	},
	group: "2_move",
	order: 40,
});
...
MenuRegistry.appendMenuItem(MenuId.EditorTitle, {
	...
	group: "3_open",
	order: 10,
	when: EditorPartModalContext.toNegated() /* not applicable to modal editor */,
});
MenuRegistry.appendMenuItem(MenuId.EditorTitle, {
	command: {
		id: CLOSE_EDITORS_IN_GROUP_COMMAND_ID,
