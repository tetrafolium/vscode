...
suite("Notifications Position", () => {
	...
	suite("Configuration", () => {
		test("defaults to bottom-right when no configuration is set", () => {
			...
			const position =
				configurationService.getValue<NotificationsPosition>(
	...
	suite("Status Bar Alignment", () => {
		...
		test("bottom-right position aligns bell to right", () => {
			assert.strictEqual(
				getDesiredAlignment(NotificationsPosition.BOTTOM_RIGHT),
				"right",
			);
		});
		...
		test("bottom-left position aligns bell to left", () => {
			assert.strictEqual(
				getDesiredAlignment(NotificationsPosition.BOTTOM_LEFT),
				"left",
			);
		});
		...
		test("top-right position hides status bar bell", () => {
			assert.strictEqual(
				getDesiredAlignment(NotificationsPosition.TOP_RIGHT),
				"hidden",
			);
		});
	});
	...
	suite("Top Offset for Top-Right", () => {
		...
		test("bottom-right has no top offset", () => {
			assert.strictEqual(
				computeTopOffset(NotificationsPosition.BOTTOM_RIGHT, true),
				undefined,
			);
		});
		...
		test("bottom-left has no top offset", () => {
			assert.strictEqual(
				computeTopOffset(NotificationsPosition.BOTTOM_LEFT, true),
				undefined,
			);
		});
		...
		test("top-right without titlebar has 7px offset", () => {
			assert.strictEqual(
				computeTopOffset(NotificationsPosition.TOP_RIGHT, false),
				7,
			);
		});
		...
		test("top-right with titlebar has 42px offset", () => {
			assert.strictEqual(
				computeTopOffset(NotificationsPosition.TOP_RIGHT, true),
				42,
			);
		});
	});
	...
	suite("Hide Notifications Icon", () => {
		...
		test("bottom-right uses chevron down icon", () => {
			assert.strictEqual(
				getHideIcon(NotificationsPosition.BOTTOM_RIGHT).id,
				hideIcon.id,
			);
		});
		...
		test("bottom-left uses chevron down icon", () => {
			assert.strictEqual(
				getHideIcon(NotificationsPosition.BOTTOM_LEFT).id,
				hideIcon.id,
			);
		});
		...
		test("top-right uses chevron up icon", () => {
			assert.strictEqual(
				getHideIcon(NotificationsPosition.TOP_RIGHT).id,
				hideUpIcon.id,
			);
		});
	...
	suite("Expand/Collapse Notification Icons", () => {
		test("bottom-right expand uses notifications-expand icon", () => {
			assert.strictEqual(
				getNotificationExpandIcon(NotificationsPosition.BOTTOM_RIGHT).id,
		...
		test("bottom-left expand uses notifications-expand icon", () => {
			assert.strictEqual(
				getNotificationExpandIcon(NotificationsPosition.BOTTOM_LEFT).id,
				"notifications-expand",
			);
		});
		...
		test("top-right expand uses notifications-expand-down icon", () => {
			assert.strictEqual(
				getNotificationExpandIcon(NotificationsPosition.TOP_RIGHT).id,
		...
		test("bottom-right collapse uses notifications-collapse icon", () => {
			assert.strictEqual(
				getNotificationCollapseIcon(NotificationsPosition.BOTTOM_RIGHT).id,
		...
		test("bottom-left collapse uses notifications-collapse icon", () => {
			assert.strictEqual(
				getNotificationCollapseIcon(NotificationsPosition.BOTTOM_LEFT).id,
				"notifications-collapse",
			);
		});
		...
		test("top-right collapse uses notifications-collapse-up icon", () => {
			assert.strictEqual(
				getNotificationCollapseIcon(NotificationsPosition.TOP_RIGHT).id,
