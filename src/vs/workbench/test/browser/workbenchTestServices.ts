...
import {
	...
	IToastOptions,
	IToastResult,
} from "../../services/host/browser/host.js";
...
export function workbenchInstantiationService(
	...
	instantiationService.stub(
		IMarkdownRendererService,
		instantiationService.createInstance(MarkdownRendererService),
	);
	instantiationService.stub(
		IChatWidgetService,
		instantiationService.createInstance(TestChatWidgetService),
	);
...
export class TestHostService implements IHostService {
	...
	async getWindows(options: unknown) {
		return [];
	}
...
export interface ITestTextFileEditorModelManager
	extends ITextFileEditorModelManager, IDisposable {
...
export class TestTerminalProfileService implements ITerminalProfileService {
	...
	registerInternalContributedProfile(
		_profile: IExtensionTerminalProfile,
	): IDisposable {
		return Disposable.None;
	}
...
export class TestQuickInputService implements IQuickInputService {
	...
	readonly alignment = observableValue(
		"TestQuickInputService.alignment",
		"top" as QuickInputAlignment,
	);
