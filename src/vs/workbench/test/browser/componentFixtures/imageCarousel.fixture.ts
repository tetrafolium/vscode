...
function createTestImages(): ICarouselImage[] {
	return [
		...
		},
		{
			...
			name: "Blue",
			mimeType: "image/png",
			data: createSolidPng(50, 80, 220),
		},
		{
			id: "img-4",
			name: "Yellow",
			mimeType: "image/png",
			data: createSolidPng(230, 210, 50),
			caption: "A yellow image",
		},
		{
			id: "img-5",
			name: "Purple",
			mimeType: "image/png",
			data: createSolidPng(150, 50, 200),
		},
	];
}
