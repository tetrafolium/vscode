	...
	horizontalBar.push([
		disposableStore.add(
			new Action(
				"editor.action.save",
				"Save",
				ThemeIcon.asClassName(Codicon.save),
				true,
				async () => console.log("Save"),
			),
		),
		disposableStore.add(
			new Action(
		...
		disposableStore.add(
			new Action(
				"editor.action.redo",
				"Redo",
				ThemeIcon.asClassName(Codicon.redo),
				true,
				async () => console.log("Redo"),
			),
		),
		new Separator(),
		disposableStore.add(
		...
		disposableStore.add(
			new Action(
				...
				"Replace",
				ThemeIcon.asClassName(Codicon.replaceAll),
				true,
				async () => console.log("Replace"),
			),
		),
	]);
	...
	mixedBar.push([
		...
		disposableStore.add(
			new Action(
				"action.disabled",
				"Disabled",
				ThemeIcon.asClassName(Codicon.debugPause),
				false,
				async () => {},
			),
		),
		disposableStore.add(
			new Action(
				"action.enabled2",
				"Enabled",
				ThemeIcon.asClassName(Codicon.debugStop),
				true,
				async () => {},
			),
		),
