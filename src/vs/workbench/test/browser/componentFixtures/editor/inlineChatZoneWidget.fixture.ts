...
import {
	IChatModeService,
	ChatMode,
} from "../../../../contrib/chat/common/chatModes.js";
...
function renderInlineChatZoneWidget(
	{ container, disposableStore, theme }: ComponentFixtureContext,
	showTerminationCard: boolean,
): void {
	...
	styleReset.textContent =
		".component-fixture-box-sizing-reset, .component-fixture-box-sizing-reset * { box-sizing: revert; }";
		...
		additionalServices: (reg) => {
			...
			reg.defineInstance(
				...
				new (class extends mock<IChatService>() {
					...
					override readonly requestInProgressObs = observableValue(
						"requestInProgress",
						false,
					);
				})(),
			...
			reg.defineInstance(
				IChatLayoutService,
				new (class extends mock<IChatLayoutService>() {
					override readonly fontFamily = observableValue<string | null>(
						"fontFamily",
						null,
					);
			...
			reg.defineInstance(
				IChatTipService,
				new (class extends mock<IChatTipService>() {
			...
			reg.defineInstance(
				IChatDebugService,
				new (class extends mock<IChatDebugService>() {
			...
			reg.defineInstance(
				...
				new (class extends mock<IChatSessionsService>() {
					override getAllChatSessionContributions() {
						return [];
					}
					...
					override sessionSupportsFork() {
						return false;
					}
					override supportsDelegationForSessionType() {
						return false;
					}
					override getOptionGroupsForSessionType() {
						return undefined;
					}
					override getCustomAgentTargetForSessionType() {
						return Target.Undefined;
					}
					override requiresCustomModelsForSessionType() {
						return false;
					}
					override getChatSessionContribution() {
						return undefined;
					}
					override getCapabilitiesForSessionType() {
						return undefined;
					}
			...
			reg.defineInstance(
				...
				new (class extends mock<ILanguageModelToolsService>() {
					...
					override observeTools() {
						return observableValue("tools", []);
					}
					override getToolSetsForModel() {
						return [];
					}
				})(),
			);
			...
			reg.defineInstance(
				IChatContextService,
				new (class extends mock<IChatContextService>() {})(),
			);
			reg.defineInstance(
				IChatAttachmentWidgetRegistry,
				new (class extends mock<IChatAttachmentWidgetRegistry>() {})(),
			);
			reg.defineInstance(
			...
			reg.defineInstance(
				...
				new (class extends mock<IChatImageCarouselService>() {})(),
			);
			reg.defineInstance(
				IChatArtifactsService,
				new (class extends mock<IChatArtifactsService>() {
					override getArtifacts(): IChatArtifacts {
						return new (class extends mock<IChatArtifacts>() {
							override readonly artifactGroups = observableValue<
								readonly IArtifactSourceGroup[]
							>("artifactGroups", []);
			...
			reg.defineInstance(
				...
				new (class extends mock<IChatTodoListService>() {
			...
			reg.defineInstance(
				...
				new (class extends mock<IChatWidgetHistoryService>() {
					override getHistory() {
						return [];
					}
			...
			reg.defineInstance(
				...
				new (class extends mock<IChatEditingService>() {
					override editingSessionsObs = observableValue(
						"editingSessionsObs",
						[],
					);
				})(),
			...
			reg.defineInstance(
				...
				new (class extends mock<IChatInputNotificationService>() {
					override readonly onDidChange = Event.None;
					override getActiveNotification() {
						return undefined;
					}
				})(),
			);
			...
			reg.defineInstance(
				...
				new (class extends mock<IChatContextPickService>() {})(),
			);
			reg.defineInstance(
				IDecorationsService,
				new (class extends mock<IDecorationsService>() {
					override readonly onDidChangeDecorations = Event.None;
				})(),
			);
			reg.defineInstance(
				ITextFileService,
				new (class extends mock<ITextFileService>() {
					override readonly untitled = new (class extends mock<
						ITextFileService["untitled"]
					>() {
			...
			reg.defineInstance(
				...
				new (class extends mock<IWorkbenchAssignmentService>() {
					override async getCurrentExperiments() {
						return [];
					}
					override async getTreatment() {
						return undefined;
					}
			...
			reg.defineInstance(
				...
				new (class extends mock<IWorkspaceContextService>() {
					...
					override getWorkspace(): IWorkspace {
						return { id: "", folders: [], configuration: undefined };
					}
				})(),
			);
			reg.defineInstance(
			...
			reg.defineInstance(
				...
				new (class extends mock<INotebookDocumentService>() {})(),
			);
			reg.defineInstance(
				ISCMService,
				new (class extends mock<ISCMService>() {
			...
			reg.defineInstance(
				...
				new (class extends mock<IUpdateService>() {
					...
					override get state() {
						return { type: StateType.Uninitialized as const };
					}
				})(),
			);
			reg.defineInstance(
	...
	const zoneWidget = disposableStore.add(
		instantiationService.createInstance(
	...
	const dummyModel = disposableStore.add(
