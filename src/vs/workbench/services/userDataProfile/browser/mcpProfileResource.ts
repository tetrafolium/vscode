...
export class McpProfileResource implements IProfileResource {
	...
	async getMcpResourceContent(
		profile: IUserDataProfile,
	): Promise<IMcpResourceContent> {
...
export class McpResourceTreeItem implements IProfileResourceTreeItem {
	...
	async hasContent(): Promise<boolean> {
		const mcpContent = await this.instantiationService
			.createInstance(McpProfileResource)
			.getMcpResourceContent(this.profile);
