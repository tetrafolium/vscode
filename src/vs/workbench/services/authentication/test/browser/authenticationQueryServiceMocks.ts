 ...
 */
export class TestUsageService
	extends BaseTestService
...
export class TestMcpUsageService
	extends BaseTestService
	...
	implements IAuthenticationAccessService
{
	...
	onDidChangeExtensionSessionAccess =
	...
	isAccessAllowed(
		...
		const extensions =
			this.data.get(this.getKey(providerId, accountName)) || [];
...
export class TestMcpAccessService
	extends BaseTestService
...
export class TestExtensionsService
	extends TestPreferencesService
	...
	implements IAuthenticationService
{
	...
	private readonly accountsMap = new Map<
		string,
		AuthenticationSessionAccount[]
	>();
	...
	addAccounts(
		providerId: string,
		accounts: AuthenticationSessionAccount[],
	): void {
	...
	async getAccounts(
		providerId: string,
	): Promise<readonly AuthenticationSessionAccount[]> {
	...
	createOrGetXaaProvider(): Promise<string | undefined> {
		return Promise.resolve(undefined);
	}
