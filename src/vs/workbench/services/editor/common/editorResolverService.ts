...
export const diffEditorsAssociationsSettingId =
 ...
 */
export const editorsAssociationsAgentsWindowDefault: Readonly<
...
export type RegisteredEditorRegistrationInfo = Omit<
...
export function toRegisteredEditorPriorityInfo(
	priority: RegisteredEditorPriority | RegisteredEditorPriorityInfo,
