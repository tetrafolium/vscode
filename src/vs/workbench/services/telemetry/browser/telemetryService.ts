...
export class TelemetryService extends Disposable implements ITelemetryService {
	...
	constructor(
		...
		this._register(
			requestService.onDidCompleteRequest((e) => {
				if (
					e.callSite === NO_FETCH_TELEMETRY ||
				...
				type FetchCallClassification = {
					...
					callSite: {
						...
						comment: "The call site that initiated the request.";
					};
					latency: {
						classification: "SystemMetaData";
						purpose: "PerformanceAndHealth";
						isMeasurement: true;
						comment: "Time in milliseconds for the request to complete.";
					};
					statusCode: {
						classification: "SystemMetaData";
						purpose: "PerformanceAndHealth";
	...
	private initializeService(
		...
		if (
			...
			const config: ITelemetryServiceConfig = {
				...
				waitForExperimentProperties: experimentsEnabled(
					configurationService,
					productService,
					environmentService,
				),
