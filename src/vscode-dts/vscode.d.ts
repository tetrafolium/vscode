...
declare module "vscode" {
	 ...
	 */
	export interface DiagnosticCollection extends Iterable<
	 ...
	 */
	export class DataTransfer implements Iterable<
	 ...
	 * {@link TestController.items}.
	 */
	export interface TestItemCollection extends Iterable<
		[id: string, testItem: TestItem]
	> {
		/**
