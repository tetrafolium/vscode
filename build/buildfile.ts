...
export const workerEditor = createModuleDescription(
	"vs/editor/common/services/editorWebWorkerMain",
);
export const workerExtensionHost = createModuleDescription(
	"vs/workbench/api/worker/extensionHostWorkerMain",
);
export const workerNotebook = createModuleDescription(
	"vs/workbench/contrib/notebook/common/services/notebookWebWorkerMain",
);
export const workerLanguageDetection = createModuleDescription(
	"vs/workbench/services/languageDetection/browser/languageDetectionWebWorkerMain",
);
export const workerLocalFileSearch = createModuleDescription(
	"vs/workbench/services/search/worker/localFileSearchMain",
);
export const workerProfileAnalysis = createModuleDescription(
	"vs/platform/profiling/electron-browser/profileAnalysisWorkerMain",
);
export const workerOutputLinks = createModuleDescription(
	"vs/workbench/contrib/output/common/outputLinkComputerMain",
);
export const workerBackgroundTokenization = createModuleDescription(
...
export const workbenchWeb = createModuleDescription(
	"vs/workbench/workbench.web.main.internal",
);

export const sessionsWeb = createModuleDescription(
...
export const codeWeb = createModuleDescription(
