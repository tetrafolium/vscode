...
export class ExtensionContentSecurityPolicyArbiter implements ContentSecurityPolicyArbiter {
	...
	readonly #should_disable_security_warning_key =
	...
	public getSecurityLevelForResource(
		...
		const level = this.#globalState.get<
			MarkdownPreviewSecurityLevel | undefined
				...
				[
					{
						...
						label:
							markActiveWhen(
								currentSecurityLevel === MarkdownPreviewSecurityLevel.Strict,
					...
					},
					{
						...
						label:
							markActiveWhen(
								currentSecurityLevel ===
									MarkdownPreviewSecurityLevel.AllowInsecureContent,
