...
export function register(
	...
	context.subscriptions.push(
		...
		vscode.commands.registerCommand("references-view.findImplementations", () =>
			findLocations("Implementations", "vscode.executeImplementationProvider"),
		),
		// --- legacy name
		vscode.commands.registerCommand("references-view.find", (...args: any[]) =>
			vscode.commands.executeCommand("references-view.findReferences", ...args),
		),
