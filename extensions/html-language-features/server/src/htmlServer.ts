...
namespace AutoInsertRequest {
	export const type: RequestType<AutoInsertParams, string | null, any> =
...
export function startServer(
	...
	connection.onRequest(
		...
		(params: TextDocumentContentParams, token: CancellationToken) => {
			return runSafe<TextDocumentContentResult>(
				runtime,
				async () => {
