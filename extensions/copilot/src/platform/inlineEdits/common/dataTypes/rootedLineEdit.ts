...
export class RootedLineEdit {
	public static fromEdit<TEdit extends BaseStringEdit>(
		edit: RootedEdit<TEdit>,
	): RootedLineEdit {
		const lineEdit = LineEdit.fromStringEdit(
			edit.edit as BaseStringEdit as StringEdit,
			edit.base,
		);
	...
	public removeCommonSuffixPrefixLines(): RootedLineEdit {
		const isNotEmptyEdit = (edit: LineReplacement) =>
			!edit.lineRange.isEmpty || edit.newLines.length > 0;
		const newEdit = this.edit.replacements
