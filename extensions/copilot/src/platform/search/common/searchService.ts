...
export const ISearchService =
	createServiceIdentifier<ISearchService>('ISearchService');

export interface ISearchService {
	readonly _serviceBrand: undefined;
	findFilesWithDefaultExcludes(
...
export abstract class AbstractSearchService implements ISearchService {
	...
	async findFilesWithDefaultExcludes(
		...
		return this._findFilesWithDefaultExcludesAndExcludes(
			include,
			undefined,
			maxResults,
			token,
	...
	protected async _findFilesWithDefaultExcludesAndExcludes(
		include: vscode.GlobPattern,
	...
	abstract findTextInFiles(
		query: vscode.TextSearchQuery,
		options: vscode.FindTextInFilesOptions,
		progress: vscode.Progress<vscode.TextSearchResult>,
		token: vscode.CancellationToken,
	): Promise<vscode.TextSearchComplete>;
	abstract findTextInFiles2(
		query: vscode.TextSearchQuery2,
		options?: vscode.FindTextInFilesOptions2,
		token?: vscode.CancellationToken,
	): vscode.FindTextInFilesResponse;
