 ...
 */
export function inferAlternativeNotebookContentFormat(
	content: string,
...
export const IAlternativeNotebookContentService =
	createServiceIdentifier<IAlternativeNotebookContentService>(
...
export interface IAlternativeNotebookContentService {
	...
	getFormat(
		options: LanguageModelChat | IChatEndpoint | undefined,
	): AlternativeContentFormat;
	create(
...
export class AlternativeNotebookContentService implements IAlternativeNotebookContentService {
	...
	getFormat(
		...
		return this.configurationService.getExperimentBasedConfig(
			ConfigKey.Advanced.NotebookAlternativeDocumentFormat,
...
export function getAltNotebookRange(
	...
	const doc =
		getAlternativeNotebookDocumentProvider(format).getAlternativeDocument(
			notebook,
		);
	return new Range(
