...
export function setCopilotToken(
	...
	if (!(authenticationService instanceof StaticGitHubAuthenticationService)) {
		throw new Error(
			'This function should only be used with StaticGitHubAuthenticationService',
		);
	}
	(
		authenticationService as StaticGitHubAuthenticationService
