...
export const IFetcherService =
	createServiceIdentifier<IFetcherService>('IFetcherService');
...
export class Response {
	...
	constructor(
		...
		this.body = new DestroyableStream(
			inputStream.pipeThrough(countingStream),
		);
	}
...
export class HeadersImpl implements IHeaders {
	constructor(
		private readonly _record: Readonly<
