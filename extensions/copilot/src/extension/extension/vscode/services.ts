...
import {
	IUrlOpener,
	NullUrlOpener,
} from '../../../platform/open/common/opener';
import { RealUrlOpener } from '../../../platform/open/vscode/opener';
import {
	IProjectTemplatesIndex,
	ProjectTemplatesIndex,
} from '../../../platform/projectTemplatesIndex/common/projectTemplatesIndex';
import {
...
} from '../../tools/common/virtualTools/toolEmbeddingsComputer';
...
export function registerServices(
	...
	builder.define(
		IAlternativeNotebookContentService,
		new SyncDescriptor(AlternativeNotebookContentService),
	);
	builder.define(
		IAlternativeNotebookContentEditGenerator,
	...
	builder.define(
		IUrlOpener,
		isTestMode && !isScenarioAutomation
			? new NullUrlOpener()
			: new RealUrlOpener(),
	);
	builder.define(
	...
	builder.define(
		...
		<any>/*force _serviceBrand*/ extensionContext,
	);
	...
	builder.define(
		...
		new SyncDescriptor(ConfigurationServiceImpl),
	);
	builder.define(
		ILogService,
		new SyncDescriptor(LogServiceImpl, [
			[new NewOutputChannelLogTarget(extensionContext)],
		]),
	);
	...
	builder.define(
		...
		new SyncDescriptor(LanguageFeaturesServiceImpl),
	);
	builder.define(
		IRunCommandExecutionService,
		new SyncDescriptor(RunCommandExecutionServiceImpl),
	);
	builder.define(
		ISimulationTestContext,
	...
	builder.define(
		ICombinedEmbeddingIndex,
		new SyncDescriptor(VSCodeCombinedIndexImpl, [/*useRemoteCache*/ true]),
	);
	builder.define(
		IProjectTemplatesIndex,
		new SyncDescriptor(ProjectTemplatesIndex, [/*useRemoteCache*/ true]),
	);
	builder.define(
		IBlockedExtensionService,
	...
	builder.define(
		IEditSurvivalTrackerService,
		new SyncDescriptor(EditSurvivalTrackerService),
	);
	builder.define(
		IPromptPathRepresentationService,
	...
	builder.define(
		...
		new InteractiveSessionServiceImpl(),
	);
	builder.define(
