...
export const IAIEvaluationService =
	createServiceIdentifier<IAIEvaluationService>('IAIEvaluationService');
		...
		return (
			<>
				<SystemMessage priority={1001}>
					You are a world class examiner and must decide whether a
					response fulfills a given criteria
					<br />
					<br />
					Think step by step:
					<br />
					...
					<br />
					2. Evaluate whether the response addresses the criteria
					adequately.
					<br />
					3. If the evaluation is negative, end your reply with a line
					that starts with 'FAIL', followed by a single sentence
					explaining why.
					<br />
					4. If the evaluation is positive, end your reply with a line
					that starts with 'PASS, followed by a single sentence
					explaining why.
					<br />
					5. Do not add any additional feedback or comments after the
					line with 'FAIL' or 'PASS'
					<br />
					<br />
				...
				<UserMessage flexGrow={1}>
					...
					Please reply with your evaluation of whether the response
					meets the criteria. Finish your reply with a line that
					starts with "PASS" or "FAIL" followed by a single sentence
					that explains why. Do not add any additional feedback or
					comments after the line with "FAIL" or "PASS".
				</UserMessage>
			</>
		);
	}
