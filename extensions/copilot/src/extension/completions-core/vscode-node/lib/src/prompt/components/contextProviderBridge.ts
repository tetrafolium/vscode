...
export const ICompletionsContextProviderBridgeService =
...
export class ContextProviderBridge implements ICompletionsContextProviderBridgeService {
	...
	private scheduledResolutions = new LRUCacheMap<
		string,
	...
	constructor(
		@ICompletionsContextProviderRegistryService
		private readonly contextProviderRegistry: ICompletionsContextProviderRegistryService,
	) {}
	...
	schedule(
		...
		const resolutionPromise =
			this.contextProviderRegistry.resolveAllProviders(
				completionId,
				opportunityId,
				{
