 ...
 */
export function isInlineSuggestionFromTextAfterCursor(
	textAfterCursor: string,
): boolean | undefined {
	// Checks if we're in the position for the middle of the line suggestion
	const isMiddleOfLine =
		isMiddleOfTheLineFromTextAfterCursor(textAfterCursor);
	const isValidMiddleOfLine =
		isValidMiddleOfTheLineFromTextAfterCursor(textAfterCursor);
 ...
 */
export function determineIsInlineSuggestionPosition(
...
function isMiddleOfTheLineFromTextAfterCursor(
	textAfterCursor: string,
): boolean {
...
function isValidMiddleOfTheLineFromTextAfterCursor(
	textAfterCursor: string,
): boolean {
