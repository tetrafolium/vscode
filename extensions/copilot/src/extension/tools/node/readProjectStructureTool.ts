...
class ReadProjectStructureTool implements vscode.LanguageModelTool<IReadProjectStructureTool> {
	...
	async invoke(
		options: vscode.LanguageModelToolInvocationOptions<IReadProjectStructureTool>,
	...
	prepareInvocation?(
		options: vscode.LanguageModelToolInvocationPrepareOptions<IReadProjectStructureTool>,
