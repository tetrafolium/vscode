...
const NOTEBOOK_FOLLOW_IN_SESSION_KEY =
	'github.copilot.notebookFollowInSessionEnabled';
...
export class NotebookFollowCommands extends Disposable {
	...
	constructor(
		...
		this.followSettingEnabled = this._configurationService.getConfig(
			ConfigKey.NotebookFollowCellExecution,
		);
	...
	private updateFollowContext(value: boolean): void {
		vscode.commands.executeCommand(
			'setContext',
			NOTEBOOK_FOLLOW_IN_SESSION_KEY,
			value,
		);
