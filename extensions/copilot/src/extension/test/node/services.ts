...
} from '../../../extension/tools/common/virtualTools/virtualToolTypes';
import {
...
import {
	...
	NoopGitCommitMessageService,
} from '../../../platform/git/common/gitCommitMessageService';
...
import {
	...
	SimulationNotebookSummaryTracker,
...
import {
	...
	NullWorkspaceChunkSearchService,
...
} from '../../chatSessions/claude/common/claudePlanFileTracker';
...
import {
	ClaudeCodeModels,
	IClaudeCodeModels,
} from '../../chatSessions/claude/node/claudeCodeModels';
...
} from '../../prompt/node/promptVariablesService';
import {
...
} from '../../xtab/common/similarFilesContextService';
...
export function createExtensionUnitTestingServices(
	...
	testingServiceCollection.define(
		ILogService,
		new SyncDescriptor(TestLogService),
	);
	testingServiceCollection.define(
		IAdoCodeSearchService,
	...
	testingServiceCollection.define(
		IWorkspaceChunkSearchService,
		new SyncDescriptor(NullWorkspaceChunkSearchService),
	);
	testingServiceCollection.define(
		IPromptVariablesService,
	...
	testingServiceCollection.define(
		IChatMLFetcher,
		new SyncDescriptor(MockChatMLFetcher),
	);
	testingServiceCollection.define(
		IToolsService,
		new SyncDescriptor(TestToolsService, [new Set()]),
	);
	testingServiceCollection.define(
	...
	testingServiceCollection.define(
		...
		new SyncDescriptor(MockClaudeCodeSdkService),
	);
	testingServiceCollection.define(
		IClaudeToolPermissionService,
		new SyncDescriptor(MockClaudeToolPermissionService),
	);
	testingServiceCollection.define(
		IClaudePlanFileTracker,
	...
	testingServiceCollection.define(
		IClaudeCodeModels,
		new SyncDescriptor(ClaudeCodeModels),
	);
	testingServiceCollection.define(
	...
	testingServiceCollection.define(
		...
		new SyncDescriptor(SimulationNotebookSummaryTracker),
	);
	testingServiceCollection.define(
		ITerminalService,
		new SyncDescriptor(NullTerminalService),
	);
	testingServiceCollection.define(
		IToolGroupingCache,
	...
	testingServiceCollection.define(
		IToolEmbeddingsComputer,
		new SyncDescriptor(TestToolEmbeddingsComputer),
	);
	testingServiceCollection.define(
		IEmbeddingsComputer,
	...
	testingServiceCollection.define(
		...
		new SyncDescriptor(MockLanguageModelServer),
	);
	testingServiceCollection.define(
		IEditToolLearningService,
	...
	testingServiceCollection.define(
		IGitCommitMessageService,
		new SyncDescriptor(NoopGitCommitMessageService),
	);
	testingServiceCollection.define(
		IGithubAvailableEmbeddingTypesService,
	...
	testingServiceCollection.define(
		IChatHookService,
		new SyncDescriptor(NullChatHookService),
	);
	testingServiceCollection.define(
		ISessionTranscriptService,
	...
	testingServiceCollection.define(
		IChatDebugFileLoggerService,
		new SyncDescriptor(NullChatDebugFileLoggerService),
	);
	testingServiceCollection.define(
		IChatWebSocketManager,
	...
	testingServiceCollection.define(
		IAutomodeService,
		new SyncDescriptor(NullAutomodeService),
	);
	testingServiceCollection.define(
		ISessionStore,
