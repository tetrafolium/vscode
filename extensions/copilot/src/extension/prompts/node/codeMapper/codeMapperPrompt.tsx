		...
		return (
			<>
				...
				<SystemMessage priority={1000}>
					You are an AI programming assistant that is specialized in
					applying code changes to an existing document.
					<br />I have a code block that represents a suggestion for a
					code change and I have a {document.languageId} file opened
					in a code editor.
					<br />
					I expect you to come up with code changes that apply the
					code block to the editor.
					<br />
					I want the changes to be applied in a way that is safe and
					does not break the existing code, is correctly indented and
					matching the code style.
					<br />
					For the response, always follow these instructions:
					<br />
					1. Analyse the code block, the content of the editor and the
					current selection to decide if the code block should replace
					existing code or is to be inserted.
					<br />
					2. A line comment with `{EXISTING_CODE_MARKER}` indicates a
					section of code that has not changed
					<br />
					3. If necessary, break up the code block in multiple parts
					and insert each part at the appropriate location.
					<br />
					4. If necessary, make changes to other parts in the editor
					so that the final result is valid, properly formatted and
					indented.
					<br />
					...
					<Tag name="example" priority={100}>
						<Tag name="user">
							...
							/>
							<br />
							This is the code block that represents a suggestion
							for a code change:
							<br />
							<UnsafeCodeBlock
							...
							/>
							<br />
							Please find out how the code block can be applied to
							the editor.
						</Tag>
						<Tag name="assistant">
							<PatchEditExamplePatch
				...
				<UserMessage priority={700}>
					...
					/>
					This is the code block that represents a suggestion for a
					code change:
					<br />
					<CodeBlock
						uri={document.uri}
					...
					<br />
					<Tag name="userPrompt">
						Please find out how the code block can be applied to the
						editor. Provide the code changes in the format as
						described above.
						<br />
					</Tag>
				</UserMessage>
		...
		if (isNewDocument(this.props.request)) {
			...
			return (
				<>
					...
					/>
					<SystemMessage priority={1000}>
						You are an AI programming assistant that is specialized
						in generating code for a new document.
						<br />
						<LegacySafetyRules />
						The user has a code block that represents a suggestion
						for the contents of a single new file, and several other
						files opened in a code editor.
						<br />
						The provided files may contain code relevant to the new
						file. Consider them when generating the new file.
						<br />
						For the response, always follow these instructions:
						<br />
						1. Analyse the code block and the existing documents to
						decide which parts of the existing document should be
						incorporated in the generated code.
						<br />
						2. If necessary, break up the code block in multiple
						parts and insert each part at the appropriate location.
						<br />
						3. Preserve whitespace and newlines right after the
						parts of the file that you modify.
						<br />
						4. The final result must be syntactically valid,
						properly formatted, and correctly indented. It should
					...
					<UserMessage priority={700}>
								...
								document.lineCount === 0 ? undefined : (
									<Chunk>
										<>
											...
											file {document.uri.toString()} open
											in the editor, starting from line 1
						...
						<Chunk priority={695}>
							...
							/>
							This is the code block that represents the suggested
							code change:
							<br />
							<CodeBlock
					...
					{this.props.inProgressRewriteContent && (
						<>
							...
							<UserMessage priority={900}>
								Please continue providing the next part of the
								response.
							</UserMessage>
						</>
					)}
		...
		return (
			<>
				...
				<SystemMessage priority={1000}>
					...
					code change and a {document.languageId} file opened in a
					code editor.
					<br />
					Rewrite the existing document to fully incorporate the code
					changes in the provided code block.
					<br />
					For the response, always follow these instructions:
					<br />
					1. Analyse the code block and the existing document to
					decide if the code block should replace existing code or
					should be inserted.
					<br />
					2. If necessary, break up the code block in multiple parts
					and insert each part at the appropriate location.
					<br />
					3. Preserve whitespace and newlines right after the parts of
					the file that you modify.
					<br />
					4. The final result must be syntactically valid, properly
					formatted, and correctly indented. It should not contain any
					...existing code... comments.
					<br />
					5. Finally, provide the fully rewritten file. You must
				...
				<UserMessage priority={700}>
					...
					/>
					This is the code block that represents the suggested code
					change:
					<br />
					<CodeBlock
						uri={document.uri}
					...
					<br />
					<Tag name="userPrompt">
						Provide the fully rewritten file, incorporating the
						suggested code change. You must produce the complete
						file.
					</Tag>
				</UserMessage>
				{this.props.inProgressRewriteContent && (
