	...
	async render(state: void, sizing: PromptSizing) {
		...
		if (
			...
			throw illegalArgument(
				'InlineChatEditMarkdownPrompt should not be used with a notebook!',
			);
		}

		if (languageId !== 'markdown') {
			throw illegalArgument(
				'InlineChatEditMarkdownPrompt should only be used with markdown documents!',
			);
		}
			...
			<>
				...
				>
					...
					<Tag name="userPrompt">
						...
						{data.placeholderText} wrapped with{' '}
						{MarkdownBlock.FenceSequence} is:
					</Tag>
				</UserMessage>
			</>
		);
