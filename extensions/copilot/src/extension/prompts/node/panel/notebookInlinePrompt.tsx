		...
		const instructions = (
			<InstructionMessage priority={900}>
				<Tag name="instructions">
					...
					user asked for it. Use the {ToolName.EditNotebook} tool
					instead.
					<br />
					Do not summarize the changes after making the edits and
					leave the response empty if there is nothing more to add.
					<br />
				...
				<Tag name="toolUseInstructions">
					...
					of saying that you'll use the {ToolName.EditNotebook} tool,
					say "I'll edit the project.js file".
					<br />
				</Tag>
