...
const THOROUGHNESS_GUIDANCE: Record<
	NonNullable<SearchSubagentPromptProps['thoroughness']>,
	string
> = {
...
export class SearchSubagentPrompt extends PromptElement<SearchSubagentPromptProps> {
	async render(state: void, sizing: PromptSizing) {
		...
		const thoroughnessGuidance = this.props.thoroughness
			? THOROUGHNESS_GUIDANCE[this.props.thoroughness]
			: undefined;

		return (
			<>
				<SystemMessage priority={1000}>
					You are an AI coding research assistant that uses search
					tools to gather information. You can call tools to search
					for information and read files across a codebase.
					<br />
					<br />
					...
					Once you have searched the repository, return a message with
					ONLY: the &lt;final_answer&gt; tag to provide paths and line
					ranges of relevant code snippets.
					<br />
					<br />
					Example:
					<br />
				...
				{isLastTurn && (
					<UserMessage priority={900}>
						OK, your allotted iterations are finished -- you must
						produce a list of code references as the final answer,
						starting and ending with &lt;final_answer&gt;.
					</UserMessage>
				)}
			</>
		);
