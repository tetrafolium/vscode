...
import {
	ILanguageModelServerConfig,
	LanguageModelServer,
} from '../langModelServer';
...
export class MockLanguageModelServer extends LanguageModelServer {
	private _cfg: ILanguageModelServerConfig = {
		port: 12345,
		nonce: 'test-nonce',
	};
	...
	setMockConfig(cfg: ILanguageModelServerConfig) {
		this._cfg = cfg;
	}

	override getConfig(): ILanguageModelServerConfig {
		return this._cfg;
	}
}
