...
} from '../simulation/inlineChatSimulator';
import {
	assertLessDiagnosticsAsync,
	assertNoDiagnosticsAsync,
	getWorkspaceDiagnostics,
} from '../simulation/outcomeValidators';
import {
	assertConversationalOutcome,
	assertInlineEdit,
	assertNoOccurrence,
	assertOccursOnce,
	fromFixture,
	toFile,
} from '../simulation/stestUtil';

forInlineChatIntent((strategy, nonExtensionConfigurations, suffix) => {
	ssuite(
		{ title: `fix${suffix}`, subtitle: 'ruff', location: 'inline' },
		() => {
			stest(
				{
					description: `Ruff(E231) Missing whitespace after ':'`,
					language: 'python',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						strategy,
						testingServiceCollection,
						{
							files: [
								fromFixture('fixing/ruff/ruff_error_E231.py'),
							],
							queries: [
								{
	...
	ssuite(
		{ title: `fix${suffix}`, subtitle: 'TSC', location: 'inline' },
		() => {
			stest(
				{
					description:
						'Error 2322 - type undefined is not assignable to type',
					language: 'typescript',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/typescript/tsc_error_2322.ts',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description:
						'22222 Error 2322 - type undefined is not assignable to type',
					language: 'typescript',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
			...
			stest(
				{
					description:
						'Error 1015 - parameter cannot have question mark and initializer, with corresponding diagnostics',
					language: 'typescript',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/typescript/tsc_error_1015.ts',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description:
						'Error 1015 - parameter cannot have question mark and initializer, without corresponding diagnostics',
					language: 'typescript',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
			...
			stest(
				{
					description:
						'Error 2420 - incorrect interface implementation',
					language: 'typescript',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/typescript/tsc_error_2420/file0.ts',
								),
								fromFixture(
									'fixing/typescript/tsc_error_2420/file1.ts',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description:
						'Error 2420 - incorrect interface implementation, with related information',
					language: 'typescript',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
			...
			stest(
				{
					description:
						'Error 2391 - function implementation is missing or not immediately following the declaration',
					language: 'typescript',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/typescript/tsc_error_2391.ts',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description:
						'Error 2454 - variable is used before being assigned',
					language: 'typescript',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/typescript/tsc_error_2454.ts',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description:
						'Error 2339 - property does not exist on type 1',
					language: 'typescript',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/typescript/tsc_error_2339_1.ts',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description:
						'Error 2554 - expected m arguments, but got n.',
					language: 'typescript',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/typescript/tsc_error_2554.ts',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description:
						'Error 2341 - property is private and only accessible within class',
					language: 'typescript',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/typescript/tsc_error_2341.ts',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description:
						'Error 2355 - a function whose declared type is neither undefined, void, nor any must return a value.',
					language: 'typescript',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/typescript/tsc_error_2355.ts',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description:
						'Error 2339 - (AML-10-55) property does not exist on type 2',
					language: 'typescript',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/typescript/tsc_error_2339_2.ts',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description:
						'Error 2339 - (AML-10-98) property does not exist on type 3',
					language: 'typescript',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/typescript/tsc_error_2339_3.ts',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description: 'Error 2304 - can not find name',
					language: 'typescript',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/typescript/tsc_error_2304/file0.ts',
								),
								fromFixture(
									'fixing/typescript/tsc_error_2304/file1.ts',
								),
							],
							queries: [
								{
									...
									validate: async (
										...
										await assertNoDiagnosticsAsync(
											accessor,
											outcome,
											workspace,
											'tsc',
										...
										if (outcome.type === 'inlineEdit') {
											const indexOfFsImport =
												outcome.fileContents.indexOf(
													`import { readFileSync } from 'fs';`,
												);
											assert.ok(
												indexOfFsImport >= 0,
												'contains readFileSync import',
											);
											const indexOfDeclare =
												outcome.fileContents.indexOf(
													`declare function`,
												);
											assert.ok(
			...
			stest(
				{
					description: 'Error 2304 - (AML-10-14) can not find module',
					language: 'typescript',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/typescript/tsc_error_2304_1.ts',
								),
							],
							queries: [
								{
									...
									validate: async (
										...
										const filtered = diagnostics.filter(
											(d) =>
												d.code !== 2307 &&
												d.code !== 2305,
										); // filter module not found, module has not exported member
										assert.equal(
											filtered.length,
											0,
											'only module not found diagnostics',
										);
									},
								},
							],
			...
			stest(
				{
					description: 'Error 2307 - can not find module',
					language: 'typescript',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/typescript/tsc_error_2307_can_not_find_module.ts',
								),
							],
							queries: [
								{
									...
									validate: async (
										...
										const match =
											outcome.chatResponseMarkdown.match(
			...
			stest(
				{
					description: 'Error 18047 - (AML-10-64) possibly null',
					language: 'typescript',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/typescript/tsc_error_18047.ts',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description:
						'Error 7006 - (AML-10-23) implicitly has any type',
					language: 'typescript',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/typescript/tsc_error_7006.ts',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description:
						'Error 18047 - (AML-8-1) property does not exist on type window',
					language: 'typescript',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/typescript/tsc_error_2339_4.ts',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description: 'Error 18048 - (AML-10-86) possibly undefined',
					language: 'typescript',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/typescript/tsc_error_18048.ts',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description: 'Error 2304 - (AML-8-125) can not find name',
					language: 'typescript',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/typescript/tsc_error_2304_2.ts',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description: 'Error 2304 - (AML-8-125) can not find name 2',
					language: 'typescript',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/typescript/tsc_error_2304_3.ts',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description: `Error 7053 - (AML-10-25) expression of type can't be used to index`,
					language: 'typescript',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/typescript/tsc_error_7053.ts',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description:
						'(AML-10-31) Parameter data implicitly has an any type.',
					language: 'typescript',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/typescript/tsc_implicit_any.ts',
								),
							],
							queries: [
								{
				...
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/typescript/tsc_error_1128.ts',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description: 'left side of comma operator is unused',
					language: 'typescript',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/typescript/tsc_error_2695.ts',
								),
							],
							queries: [
								{
				...
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/typescript/tsc_error_2532.ts',
								),
							],
							queries: [
								{
				...
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/typescript/tsc_error_2300.ts',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description:
						'Error 2802 - large file - Type Uint32Array can only be iterated through',
					language: 'typescript',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/typescript/tsc_large_onigscanner/tsc_error_2802.ts',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description: 'can not assign to parameter of type',
					language: 'typescript',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/typescript/tsc_error_2345.ts',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description: 'Error 2345 - Last two arguments swapped',
					language: 'typescript',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					const files = [
						fromFixture(
							'fixing/typescript/tsc_error_2345_2/file0.ts',
						),
						fromFixture(
							'fixing/typescript/tsc_error_2345_2/file1.ts',
						),
						fromFixture(
							'fixing/typescript/tsc_error_2345_2/database_mock.ts',
						),
					];
					return simulateInlineChatWithStrategy(
						strategy,
			...
			stest(
				{
					description:
						'Error 2345 - Got boolean but expected options bag',
					language: 'typescript',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					const files = [
						fromFixture(
							'fixing/typescript/tsc_error_2345_3/file0.ts',
						),
						fromFixture(
							'fixing/typescript/tsc_error_2345_3/database_mock.ts',
						),
					];
					return simulateInlineChatWithStrategy(
						strategy,
			...
			stest(
				{
					description:
						'Error 2554 - Got two args but expected options bag',
					language: 'typescript',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/typescript/tsc_error_2554/legacy_database.ts',
								),
								fromFixture(
									'fixing/typescript/tsc_error_2554/file1.ts',
								),
								fromFixture(
									'fixing/typescript/tsc_error_2554/database_mock.ts',
								),
							],
							queries: [
								{
				...
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/typescript/inlineChatSimulator.ts',
								),
							],
							queries: [
								{
							...
							queries: [
								{
									...
									validate: async (
										...
										await assertNoDiagnosticsAsync(
											...
											outcome,
											workspace,
											KnownDiagnosticProviders.tscIgnoreImportErrors,
										);
									},
								},
							],
	...
	ssuite(
		{ title: `fix${suffix}`, subtitle: 'eslint', location: 'inline' },
		() => {
			stest(
				{
				...
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/typescript/eslint_unexpected_token.ts',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description: '(AML-10-52) expected conditional expression',
					language: 'typescript',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/typescript/eslint_expected_conditional_expression.ts',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description: '(AML-10-1) do not access hasOwnProperty',
					language: 'typescript',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/typescript/eslint_do_not_access_hasOwnProperty.ts',
								),
							],
							queries: [
								{
				...
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/typescript/eslint_comma_expected.ts',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description: `(AML-17-10) unexpected constant condition 1`,
					language: 'typescript',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/typescript/eslint_unexpected_constant_condition_1.ts',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description: `(AML-17-152) unreachable code`,
					language: 'typescript',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/typescript/eslint_unreachable_code.ts',
								),
							],
							queries: [
								{
									...
									selection: [5, 3, 5, 3],
									query: [`/fix Unreachable code.`].join(
										'\n',
									),
									expectedIntent: Intent.Fix,
									diagnostics: 'eslint',
			...
			stest(
				{
					description: `(AML-17-166) unexpected control character`,
					language: 'typescript',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/typescript/eslint_unexpected_control_character.ts',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description: `(AML-17-243) unexpected constant condition 2`,
					language: 'typescript',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/typescript/eslint_unexpected_constant_condition_2.ts',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description: `class-methods-use-this with cookbook`,
					language: 'typescript',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/typescript/eslint_class_methods_use_this.ts',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description: `consistent-this with cookbook`,
					language: 'typescript',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/typescript/eslint_consistent_this.ts',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description: `constructor-super with cookbook`,
					language: 'typescript',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/typescript/eslint_constructor_super.ts',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description: `func-names with cookbook`,
					language: 'typescript',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/typescript/eslint_func_names.ts',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description: `func-style with cookbook`,
					language: 'typescript',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/typescript/eslint_func_style.ts',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description: `max-lines-per-function with cookbook`,
					language: 'typescript',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/typescript/eslint_max_lines_per_function.ts',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description: `max-params with cookbook`,
					language: 'typescript',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/typescript/eslint_max_params.ts',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description: `max-statements with cookbook`,
					language: 'typescript',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/typescript/eslint_max_statements.ts',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description: `no-case-declarations with cookbook`,
					language: 'typescript',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/typescript/eslint_no_case_declarations.ts',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description: `no-dupe-else-if with cookbook`,
					language: 'typescript',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/typescript/eslint_no_dupe_else_if.ts',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description: `no-duplicate-case with cookbook`,
					language: 'typescript',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/typescript/eslint_no_duplicate_case.ts',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description: `no-duplicate-imports with cookbook`,
					language: 'typescript',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/typescript/eslint_no_duplicate_imports.ts',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description: `no-fallthrough with cookbook`,
					language: 'typescript',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/typescript/eslint_no_fallthrough.ts',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description: `no-inner-declarations with cookbook`,
					language: 'typescript',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/typescript/eslint_no_inner_declarations.ts',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description: `no-multi-assign with cookbook`,
					language: 'typescript',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/typescript/eslint_no_multi_assign.ts',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description: `no-negated-condition with cookbook`,
					language: 'typescript',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/typescript/eslint_no_negated_condition.ts',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description: `no-negated-condition 2 with cookbook`,
					language: 'typescript',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/typescript/eslint_no_negated_condition_2.ts',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description: `no-new with cookbook`,
					language: 'typescript',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/typescript/eslint_no_new.ts',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description: `no-sequences with cookbook`,
					language: 'typescript',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/typescript/eslint_no_sequences.ts',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description: `no-sparse-arrays with cookbook`,
					language: 'typescript',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/typescript/eslint_no_sparse_arrays.ts',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description: `no-sparse-arrays 2 with cookbook`,
					language: 'typescript',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/typescript/eslint_no_sparse_arrays_2.ts',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description: `no-sparse-arrays 3 with cookbook`,
					language: 'typescript',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/typescript/eslint_no_sparse_arrays_3.ts',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description: `require-await with cookbook`,
					language: 'typescript',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/typescript/eslint_require_await.ts',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description: `sort-keys with cookbook`,
					language: 'typescript',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/typescript/eslint_sort_keys.ts',
								),
							],
							queries: [
								{
			...
			stest(
				...
				(accessor) => {
					return simulateInlineChatWithStrategy(strategy, accessor, {
						files: [
							toFile({
								filePath: fromFixture(
									'fix/issue-7544/notebookMulticursor.ts',
								),
							}),
						],
						queries: [
	...
	ssuite(
		{ title: `fix${suffix}`, subtitle: 'pylint', location: 'inline' },
		() => {
			stest(
				{
					description: 'unecessary parenthesis',
					language: 'python',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/python/pylint_unecessary_parenthesis.py',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description: 'unused module imported',
					language: 'python',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/python/pylint_unused_import.py',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description: `line-too-long cookbook 1 function definition with long parameters`,
					language: 'python',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/python/pylint_line_too_long_1.py',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description: `line-too-long cookbook 2 long print statememt`,
					language: 'python',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/python/pylint_line_too_long_2.py',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description: `line-too-long cookbook 3 long dictionary / list`,
					language: 'python',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/python/pylint_line_too_long_3.py',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description: `line-too-long cookbook 4 long if condition and function call`,
					language: 'python',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/python/pylint_line_too_long_4.py',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description: `line-too-long cookbook 5 multi-line docstring`,
					language: 'python',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/python/pylint_line_too_long_5.py',
								),
							],
							queries: [
								{
	...
	ssuite(
		{ title: `fix${suffix}`, subtitle: 'pyright', location: 'inline' },
		() => {
			stest(
				{
					description: 'cannot instantiate abstract class',
					language: 'python',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/python/pyright_no_abstract_class_instantiation.py',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description:
						'all Annotated types should include at least two type arguments',
					language: 'python',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/python/pyright_annotated_types_missing_argument.py',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description:
						'should not generate an error for variables declared in outer scopes',
					language: 'python',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/python/pyright_assignment_scopes.py',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description: 'async cannot be used in a non-async function',
					language: 'python',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/python/pyright_async_in_non_async_function.py',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description: 'await cannot be used in a non-async function',
					language: 'python',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/python/pyright_await_in_non_async_function.py',
								),
							],
							queries: [
								{
				...
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/python/pyright_badtoken.py',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description: 'Bar does not define a do_something2 method',
					language: 'python',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/python/pyright_missing_method.py',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description: '(AML-10-2) can not be assigned 1',
					language: 'python',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/python/pyright_can_not_be_assigned_to_1.py',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description: '(AML-10-15) object not subscriptable',
					language: 'python',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/python/pyright_object_not_subscriptable.py',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description: '(AML-10-35) can not access member',
					language: 'python',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/python/pyright_can_not_access_member.py',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description: '(AML-10-36) can not be assigned 2',
					language: 'python',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/python/pyright_can_not_be_assigned_to_2.py',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description: '(AML-10-4) parameter already assigned',
					language: 'python',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/python/pyright_parameter_already_assigned.py',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description: '(AML-10-48) can not be assigned 3',
					language: 'python',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/python/pyright_can_not_be_assigned_to_3.py',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description: '(AML-10-58) not defined',
					language: 'python',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/python/pyright_not_defined.py',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description:
						'(AML-10-29) instance of bool has no to_string member',
					language: 'python',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/python/pyright_no_to_string_member.py',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description: '(AML-8-110) not defined',
					language: 'python',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/python/pyright_self_as_first_argument.py',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description:
						'(AML-8-73) no value for argument in function call',
					language: 'python',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/python/pyright_no_value_for_argument.py',
								),
							],
							queries: [
								{
				...
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/python/pyright_undefined_variable.py',
								),
							],
							queries: [
								{
				...
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/python/pyright_missing_import.py',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description: 'general type issue',
					language: 'python',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/python/pyright_general_type_issue.py',
								),
							],
							queries: [
								{
				...
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/python/pyright_optional_member_access.py',
								),
							],
							queries: [
								{
				...
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/python/pyright_unbound_variable.py',
								),
							],
							queries: [
								{
	...
	ssuite(
		{ title: `fix${suffix}`, subtitle: 'cpp', location: 'inline' },
		() => {
			stest(
				{
					description: 'code fix for C++',
					language: 'cpp',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [fromFixture('fixing/cpp/basic/main.cpp')],
							queries: [
								{
									file: 'main.cpp',
									selection: [5, 32],
									...
									validate: async (
										...
										await assertLessDiagnosticsAsync(
											accessor,
											outcome,
											workspace,
											'cpp',
	...
	ssuite(
		...
		() => {
				...
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/csharp/roslyn_field_never_used.cs',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description:
						'(AML-10-57) call is not awaited, execution continues',
					language: 'csharp',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/csharp/roslyn_call_not_awaited.cs',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description: '(AML-17-3523) has same name as',
					language: 'csharp',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/csharp/roslyn_has_same_name_as.cs',
								),
							],
							queries: [
								{
				...
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/csharp/roslyn_does_not_exist.cs',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description: 'does not contain a definition',
					language: 'csharp',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/csharp/roslyn_does_not_contain_definition_for.cs',
								),
							],
							queries: [
								{
				...
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/csharp/roslyn_no_argument_given.cs',
								),
							],
							queries: [
								{
				...
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/csharp/roslyn_missing_using_directive.cs',
								),
							],
							queries: [
								{
			...
			stest(
				{
					description: 'semi-colon expected',
					language: 'csharp',
					nonExtensionConfigurations,
				},
				(testingServiceCollection) => {
					return simulateInlineChatWithStrategy(
						...
						testingServiceCollection,
						{
							files: [
								fromFixture(
									'fixing/csharp/roslyn_semi_colon_expected.cs',
								),
							],
							queries: [
								{
	...
	ssuite(
		{ title: `fix${suffix}`, subtitle: 'powershell', location: 'inline' },
		() => {
			stest(
				{
					description: 'Issue #7894',
					language: 'powershell',
					nonExtensionConfigurations,
				},
				(accessor) => {
					return simulateInlineChatWithStrategy(strategy, accessor, {
						files: [
							toFile({
								filePath: fromFixture(
									'fix/issue-7894/shellIntegration.ps1',
								),
							}),
						],
						queries: [
							{
								...
								validate: async (outcome, workspace) => {
									assertInlineEdit(outcome);
									const newText = outcome.appliedEdits
										.map((e) => e.newText)
										.join('');
									assert.strictEqual(
										newText.includes('param'),
										true,
									);
								},
							},
