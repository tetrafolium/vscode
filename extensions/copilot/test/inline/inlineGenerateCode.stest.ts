...
function forInlineChatIntent(
	callback: (
		strategy: EditTestStrategy,
		variant: '-InlineChatIntent',
		nonExtensionConfigurations?: NonExtensionConfiguration[],
	) => void,
): void {
	callback(EditTestStrategy.InlineChatIntent, '-InlineChatIntent', [
...
forInlineChatIntent((strategy, variant, nonExtensionConfigurations) => {
	ssuite({ title: `generate${variant}`, location: 'inline' }, () => {
		stest(
			{
				description: 'gen-ts-ltrim',
				language: 'typescript',
				nonExtensionConfigurations,
			},
			(testingServiceCollection) => {
				return executeEditTestStrategy(
					strategy,
					testingServiceCollection,
					{
						files: [
		...
		stest(
			{
				description: 'Generate a nodejs server',
				language: 'javascript',
				nonExtensionConfigurations,
			},
			(testingServiceCollection) => {
		...
		stest(
			{
				description:
					'issue #2342: Use inline chat to generate a new function/property replaces other code',
				language: 'typescript',
				nonExtensionConfigurations,
			},
			(testingServiceCollection) => {
		...
		stest(
			{
				description: 'issue #3602: gen method',
				language: 'typescript',
				nonExtensionConfigurations,
			},
			(testingServiceCollection) => {
				return executeEditTestStrategy(
					...
					testingServiceCollection,
					{
						files: [fromFixture('gen-method-issue-3602/editor.ts')],
						queries: [
							{
								file: 'editor.ts',
								selection: [39, 0],
		...
		stest(
			{
				description: 'issue #3604: gen nestjs route',
				language: 'typescript',
				nonExtensionConfigurations,
			},
			(testingServiceCollection) => {
				return executeEditTestStrategy(
					...
					testingServiceCollection,
					{
						files: [
							fromFixture(
								'gen-nestjs-route-issue-3604/app.controller.ts',
							),
						],
						queries: [
							{
		...
		stest(
			{
				description: 'gen a palindrom fn',
				language: 'python',
				nonExtensionConfigurations,
			},
			(testingServiceCollection) => {
		...
		stest(
			{
				description: 'issue #3597: gen twice',
				language: 'javascript',
				nonExtensionConfigurations,
			},
			(testingServiceCollection) => {
				return executeEditTestStrategy(
					...
					testingServiceCollection,
					{
						files: [fromFixture('gen-twice-issue-3597/new.js')],
						queries: [
							{
								file: 'new.js',
								selection: [27, 0],
		...
		stest(
			{
				description: 'issue #3782: gen twice',
				language: 'javascript',
				nonExtensionConfigurations,
			},
			(testingServiceCollection) => {
						...
						queries: [
							...
							},
							{
								...
								validate: async (
									...
									const f1 =
										text.indexOf('function fibonacci');
									const f2 = text.indexOf(
										'\nfunction getPrimes',
										f1 + 1,
									);
		...
		stest(
			{
				description:
					'issue #2303: FILEPATH not removed from generated code in empty file',
				language: 'python',
				nonExtensionConfigurations,
			},
			(testingServiceCollection) => {
		...
		stest(
			{
				description:
					'issue #2589: IllegalArgument: line must be non-negative',
				language: 'json',
				nonExtensionConfigurations,
			},
			(testingServiceCollection) => {
		...
		stest(
			{
				description: 'issue #2269: BEGIN and END were included in diff',
				language: 'python',
				nonExtensionConfigurations,
			},
			(testingServiceCollection) => {
						...
						queries: [
							{
								...
								validate: async (
									...
									assertInlineEdit(outcome);
									assert.strictEqual(
										outcome.fileContents.includes('BEGIN'),
										false,
									);
								},
							},
		...
		stest(
			{
				description: 'Streaming gets confused due to jsdoc',
				language: 'json',
				nonExtensionConfigurations,
			},
			(testingServiceCollection) => {
		...
		stest(
			{
				description: 'code below cursor is not duplicated',
				language: 'html',
				nonExtensionConfigurations,
			},
			(testingServiceCollection) => {
				return executeEditTestStrategy(
					...
					testingServiceCollection,
					{
						files: [fromFixture('editing-html/index.html')],
						queries: [
							{
								file: 'index.html',
								selection: [3, 3],
		...
		stest(
			{
				description: 'issue #3370: generate code duplicates too much',
				language: 'typescript',
				nonExtensionConfigurations,
			},
			(testingServiceCollection) => {
				return executeEditTestStrategy(
					...
					testingServiceCollection,
					{
						files: [fromFixture('gen/inlayHintsController.ts')],
						queries: [
							{
		...
		stest(
			{
				description:
					'issue #2496: Range of interest is imprecise after a streaming edit',
				language: 'typescript',
				nonExtensionConfigurations,
			},
			(testingServiceCollection) => {
				...
				return executeEditTestStrategy(
					...
					testingServiceCollection,
					{
						files: [fromFixture('gen/strings.ts')],
						queries: [
							{
								file: 'strings.ts',
								selection: [49, 0],
		...
		stest(
			{
				description:
					'issue release#142: Inline chat updates code outside of area I expect',
				language: 'typescript',
				nonExtensionConfigurations,
			},
			(testingServiceCollection) => {
				return executeEditTestStrategy(
					...
					testingServiceCollection,
					{
						files: [
							fromFixture(
								'edit/issue-release-142/testAuthProvider.ts',
							),
						],
						queries: [
							{
		...
		stest(
			{
				description: 'issue #3778: Incorrect streaming edits',
				language: 'typescript',
				nonExtensionConfigurations,
			},
			(testingServiceCollection) => {
				return executeEditTestStrategy(
					...
					testingServiceCollection,
					{
						files: [fromFixture('gen/modelLines.ts')],
						queries: [
							{
								file: 'modelLines.ts',
								selection: [3, 0],
		...
		stest(
			{
				description:
					"issue #4179: Imports aren't inserted to the top of the file anymore",
				language: 'typescript',
				nonExtensionConfigurations,
			},
			(testingServiceCollection) => {
						...
						queries: [
							...
							},
							{
								...
								validate: async (
									...
									assertInlineEdit(outcome);
									assert.ok(
										outcome.fileContents.includes('Person'),
									);
								},
							},
							{
		...
		stest(
			{
				description:
					'issue #4080: Implementing a getter/method duplicates the signature',
				language: 'typescript',
				nonExtensionConfigurations,
			},
			(testingServiceCollection) => {
		...
		stest(
			{
				description: 'issue #3439: Bad edits in this case',
				language: 'typescript',
				nonExtensionConfigurations,
			},
			(testingServiceCollection) => {
				return executeEditTestStrategy(
					...
					testingServiceCollection,
					{
						files: [fromFixture('gen/commandCenterControl.ts')],
						queries: [
							{
						...
						queries: [
							{
								...
								validate: async (
									...
									assertSomeStrings(outcome.fileContents, [
										'if',
										'while',
									]);
									await assertNoSyntacticDiagnosticsAsync(
		...
		stest(
			{
				description: 'templated code generation',
				language: 'cpp',
				nonExtensionConfigurations,
			},
			(testingServiceCollection) => {
						...
						queries: [
							{
								...
								validate: async (
									...
									assertSomeStrings(outcome.fileContents, [
										'sorted_map',
										'sorted_json',
										'basic_json<nlohmann::sorted_map>',
									]);
									await assertNoSyntacticDiagnosticsAsync(
										accessor,
										outcome,
		...
		stest(
			{
				description:
					'issue #224: Lots of lines deleted when using interactive chat in a markdown file',
				language: 'markdown',
				nonExtensionConfigurations,
			},
			(testingServiceCollection) => {
				...
				return executeEditTestStrategy(
					...
					testingServiceCollection,
					{
						files: [fromFixture('gen/CHANGELOG.md')],
						queries: [
							{
								file: 'CHANGELOG.md',
								selection: [1, 0],
		...
		stest(
			{
				description: "doesn't handle markdown code response",
				language: 'markdown',
				nonExtensionConfigurations,
			},
			(testingServiceCollection) => {
		...
		stest(
			{
				description: 'issue #5439: import List in python',
				language: 'python',
				nonExtensionConfigurations,
			},
			(testingServiceCollection) => {
		...
		stest(
			{
				description:
					'issue #6234: generate a TS interface for some JSON',
				language: 'typescript',
				nonExtensionConfigurations,
			},
			(testingServiceCollection) => {
		...
		stest(
			{
				description:
					'Inline chat response did not use code block #6554',
				language: 'powershell',
				nonExtensionConfigurations,
			},
			(testingServiceCollection) => {
		...
		stest(
			{
				description: 'variables are used when generating',
				language: 'typescript',
				nonExtensionConfigurations,
			},
			(testingServiceCollection) => {
		...
		stest(
			{
				description: 'too much code generated #6696',
				language: 'typescript',
				nonExtensionConfigurations,
			},
			(testingServiceCollection) => {
				return executeEditTestStrategy(
					...
					testingServiceCollection,
					{
						files: [
							toFile({
								fileName:
									'generate/issue-6696/heatmapServiceImpl.ts',
						...
						queries: [
							{
								...
								validate: async (
									...
									const allNewText = outcome.appliedEdits
										.map((edit) => edit.newText)
										.join('');

									assert.strictEqual(
										allNewText.includes('TextDocument'),
										true,
									);
									assert.strictEqual(
										allNewText.includes(
									...
									assert.strictEqual(
										allNewText.includes('store.add'),
										false,
									);
									assert.strictEqual(
										allNewText.includes('onDidChange'),
										false,
									);
								},
							},
		...
		stest(
			...
			(testingServiceCollection) => {
				return executeEditTestStrategy(
					...
					{
						files: [
							fromFixture('generate/issue-6163/package.json'),
						],
						queries: [
							{
								file: 'package.json',
			...
			(testingServiceCollection) => {
				return executeEditTestStrategy(
					...
					testingServiceCollection,
					{
						files: [
							fromFixture(
								'generate/issue-6788/terminalSuggestAddon.ts',
							),
						],
						queries: [
							{
			...
			(testingServiceCollection) => {
				return executeEditTestStrategy(
					...
					testingServiceCollection,
					{
						files: [
							fromFixture(
								'generate/issue-6505/chatParserTypes.ts',
							),
						],
						queries: [
							{
					...
					files: [
						toFile({
							filePath: fromFixture(
								'generate/issue-7088/Microsoft.PowerShell_profile.ps1',
							),
						}),
					],
					queries: [
