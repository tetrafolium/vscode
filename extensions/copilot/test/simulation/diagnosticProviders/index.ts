...
import {
	PylintDiagnosticsProvider,
	PyrightDiagnosticsProvider,
} from './python';
...
export class KnownDiagnosticProviders {
	...
	public static readonly tscIgnoreImportErrors =
		new TSServerDiagnosticsProvider({ ignoreImportErrors: true });
