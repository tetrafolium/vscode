...
export class CommandCenterControl {
	...
	constructor(
		...
		this._disposables.add(
			quickInputService.onShow(this._setVisibility.bind(this, false)),
		);
		this._disposables.add(
...
class CommandCenterCenterViewItem extends BaseActionViewItem {
	...
	private _getLabel(): string {
		...
		let label = this._windowTitle.isCustomTitleFormat()
			? this._windowTitle.getWindowTitle()
