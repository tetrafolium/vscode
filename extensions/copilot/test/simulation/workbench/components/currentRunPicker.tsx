...
export const CurrentRunPicker = mobxlite.observer(
	({
		...
		const handleRenameConfirm = async () => {
			if (runToRename && newName) {
				const success = await simulationRunsProvider.renameRun(
					runToRename,
					newName,
				);
				if (success) {
