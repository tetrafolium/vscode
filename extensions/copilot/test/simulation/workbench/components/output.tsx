...
export const OutputView = mobxlite.observer(
	({ run, baseline, expand }: Props) => {
							...
							<>
								...
								<div style={{ marginLeft: '-10px' }}>
									<Editor
										lineNumbers={false}
										languageId="markdown"
										contents={ensureOutputValue(run.stdout)}
									/>
								</div>
							</>
						)}
							...
							<>
								...
								<div style={{ marginLeft: '-10px' }}>
									<Editor
										lineNumbers={false}
										languageId="markdown"
										contents={ensureOutputValue(run.stderr)}
									/>
								</div>
							</>
						)}
