...
export const globalfunctions: IEntries = {
	...
	ob_start: {
		...
		signature:
			"([ callable $output_callback [, int $chunk_size = 0 [, int $flags ]]]): bool",
	},
	...
	assert: {
		...
		signature:
			"( mixed $assertion [, string $description [, Throwable $exception ]]): bool",
	},
	...
	version_compare: {
		...
		signature:
			"( string $version1 , string $version2 , string $operator ): bool",
	},
	zend_logo_guid: {
	...
	hash_file: {
		...
		signature:
			"( string $algo , string $filename [, bool $raw_output ]): string",
	},
	hash_final: {
	...
	hash_hmac_file: {
		...
		signature:
			"( string $algo , string $filename , string $key [, bool $raw_output ]): string",
	},
	hash_hmac: {
		description: "Generate a keyed hash value using the HMAC method",
		signature:
			"( string $algo , string $data , string $key [, bool $raw_output ]): string",
	},
	hash_init: {
		description: "Initialize an incremental hashing context",
		signature:
			"( string $algo [, int $options = 0 [, string $key ]]): HashContext",
	},
	hash_pbkdf2: {
		description: "Generate a PBKDF2 key derivation of a supplied password",
		signature:
			"( string $algo , string $password , string $salt , int $iterations [, int $length = 0 [, bool $raw_output ]]): string",
	},
	hash_update_file: {
		description: "Pump data into an active hashing context from a file",
		signature:
			"( HashContext $hcontext , string $filename [, resource $scontext ]): bool",
	},
	hash_update_stream: {
	...
	openssl_x509_fingerprint: {
		...
		signature:
			'( mixed $x509 [, string $hash_algorithm = "sha1" [, bool $raw_output ]]): string',
	},
	openssl_x509_free: {
	...
	jdtojewish: {
		...
		signature:
			"( int $juliandaycount [, bool $hebrew [, int $fl = 0 ]]): string",
	},
	jdtojulian: {
	...
	date_create: {
		...
		signature:
			'([ string $time = "now" [, DateTimeZone $timezone ]]): DateTime',
	},
	...
	date_create_immutable: {
		...
		signature:
			'([ string $time = "now" [, DateTimeZone $timezone ]]): DateTimeImmutable',
	},
	...
	date_diff: {
		...
		signature:
			"( DateTimeInterface $datetime2 [, bool $absolute , DateTimeInterface $datetime1 ]): DateInterval",
	},
	date_format: {
	...
	timezone_transitions_get: {
		...
		signature:
			"([ int $timestamp_begin [, int $timestamp_end , DateTimeZone $object ]]): array",
	},
	...
	finfo_buffer: {
		...
		signature:
			"( resource $finfo , string $string [, int $options = FILEINFO_NONE [, resource $context ]]): string",
	},
	finfo_close: {
	...
	finfo_file: {
		...
		signature:
			"( resource $finfo , string $file_name [, int $options = FILEINFO_NONE [, resource $context ]]): string",
	},
	finfo_open: {
		description: "Create a new fileinfo resource",
		signature:
			"([ int $options = FILEINFO_NONE [, string $magic_file ]]): resource",
	},
	finfo_set_flags: {
	...
	fgetcsv: {
		...
		signature:
			'( resource $stream [, ?int $length = null [, string $separator = "," [, string $enclosure = \'"\' [, string $escape = "\\" ]]]]): array|false',
	},
	fgets: {
	...
	file_get_contents: {
		...
		signature:
			"( string $filename [, bool $use_include_path = false [, ?resource $context = null [, int $offset = 0 [, ?int $maxlen = null ]]]]): string|false",
	},
	file_put_contents: {
		description: "Write data to a file",
		signature:
			"( string $filename , mixed $data [, int $flags = 0 [, ?resource $context = null ]]): int|false",
	},
	file: {
		description: "Reads entire file into an array",
		signature:
			"( string $filename [, int $flags = 0 [, ?resource $context = null ]]): array|false",
	},
	fileatime: {
	...
	flock: {
		...
		signature:
			"( resource $stream , int $operation [, int &$would_block = null ]): bool",
	},
	fnmatch: {
		description: "Match filename against a pattern",
		signature:
			"( string $pattern , string $filename [, int $flags = 0 ]): bool",
	},
	fopen: {
		description: "Opens file or URL",
		signature:
			"( string $filename , string $mode [, bool $use_include_path = false [, ?resource $context = null ]]): resource|false",
	},
	fpassthru: {
	...
	fscanf: {
		...
		signature:
			"( resource $stream , string $format [, mixed &...$vars ]): array|int|false|null",
	},
	fseek: {
		description: "Seeks on a file pointer",
		signature:
			"( resource $stream , int $offset [, int $whence = SEEK_SET ]): int",
	},
	fstat: {
	...
	fwrite: {
		...
		signature:
			"( resource $stream , string $data [, ?int $length = null ]): int|false",
	},
	glob: {
	...
	mkdir: {
		...
		signature:
			"( string $pathname [, int $mode = 0777 [, bool $recursive [, resource $context ]]]): bool",
	},
	move_uploaded_file: {
	...
	parse_ini_file: {
		...
		signature:
			"( string $filename [, bool $process_sections [, int $scanner_mode = INI_SCANNER_NORMAL ]]): array",
	},
	parse_ini_string: {
		description: "Parse a configuration string",
		signature:
			"( string $ini [, bool $process_sections [, int $scanner_mode = INI_SCANNER_NORMAL ]]): array",
	},
	pathinfo: {
	...
	readfile: {
		...
		signature:
			"( string $filename [, bool $use_include_path [, resource $context ]]): int",
	},
	readlink: {
	...
	iconv_mime_encode: {
		...
		signature:
			"( string $field_name , string $field_value [, array $preferences ]): string",
	},
	iconv_set_encoding: {
	...
	numfmt_format_currency: {
		...
		signature:
			"( float $value , string $currency , NumberFormatter $fmt ): string",
	},
	numfmt_format: {
	...
	numfmt_parse_currency: {
		...
		signature:
			"( string $value , string $currency [, int $position , NumberFormatter $fmt ]): float",
	},
	numfmt_parse: {
		description: "Parse a number",
		signature:
			"( string $value [, int $type [, int $position , NumberFormatter $fmt ]]): mixed",
	},
	...
	locale_filter_matches: {
		...
		signature:
			"( string $langtag , string $locale [, bool $canonicalize ]): bool",
	},
	...
	locale_lookup: {
		...
		signature:
			"( array $langtag , string $locale [, bool $canonicalize [, string $default ]]): string",
	},
	locale_parse: {
	...
	msgfmt_parse_message: {
		...
		signature:
			"( string $locale , string $pattern , string $source , string $value ): array",
	},
	msgfmt_parse: {
	...
	datefmt_format_object: {
		...
		signature:
			"( object $object [, mixed $format = NULL [, string $locale = NULL ]]): string",
	},
	...
	datefmt_localtime: {
		...
		signature:
			"( string $value [, int $position , IntlDateFormatter $fmt ]): array",
	},
	datefmt_parse: {
		description: "Parse string to a timestamp value",
		signature:
			"( string $value [, int $position , IntlDateFormatter $fmt ]): int",
	},
	...
	resourcebundle_get: {
		...
		signature:
			"( string|int $index [, bool $fallback , ResourceBundle $r ]): mixed",
	},
	...
	transliterator_create_from_rules: {
		...
		signature:
			"( string $rules [, int $direction , string $id ]): Transliterator",
	},
	...
	transliterator_transliterate: {
		...
		signature:
			"( string $subject [, int $start [, int $end , mixed $transliterator ]]): string",
	},
	intl_get_error_code: {
	...
	grapheme_stristr: {
		...
		signature:
			"( string $haystack , string $needle [, bool $before_needle ]): string",
	},
	grapheme_strlen: {
	...
	mb_check_encoding: {
		...
		signature:
			"([ string $var [, string $encoding = mb_internal_encoding() ]]): bool",
	},
	mb_chr: {
	...
	mb_decode_numericentity: {
		...
		signature:
			"( string $str , array $convmap [, string $encoding = mb_internal_encoding() [, bool $is_hex ]]): string",
	},
	mb_detect_encoding: {
		description: "Detect character encoding",
		signature:
			"( string $str [, mixed $encoding_list = mb_detect_order() [, bool $strict ]]): string",
	},
	mb_detect_order: {
	...
	mb_send_mail: {
		...
		signature:
			"( string $to , string $subject , string $message [, mixed $additional_headers [, string $additional_parameter ]]): bool",
	},
	mb_split: {
	...
	mb_stristr: {
		...
		signature:
			"( string $haystack , string $needle [, bool $before_needle [, string $encoding = mb_internal_encoding() ]]): string",
	},
	mb_strlen: {
	...
	mb_strpos: {
		...
		signature:
			"( string $haystack , string $needle [, int $offset = 0 [, string $encoding = mb_internal_encoding() ]]): string",
	},
	mb_strrchr: {
		description:
			"Finds the last occurrence of a character in a string within another",
		signature:
			"( string $haystack , string $needle [, bool $part [, string $encoding = mb_internal_encoding() ]]): string",
	},
	mb_strrichr: {
		description:
	...
	mb_substr_count: {
		...
		signature:
			"( string $haystack , string $needle [, string $encoding = mb_internal_encoding() ]): string",
	},
	mb_substr: {
		description: "Get part of string",
		signature:
	...
	exif_read_data: {
		...
		signature:
			"( mixed $stream [, string $sections [, bool $arrays [, bool $thumbnail ]]]): array",
	},
	exif_tagname: {
	...
	pcntl_signal: {
		...
		signature:
			"( int $signo , callable|int $handler [, bool $restart_syscalls ]): bool",
	},
	pcntl_sigprocmask: {
	...
	msg_receive: {
		...
		signature:
			"( resource $queue , int $desiredmsgtype , int $msgtype , int $maxsize , mixed $message [, bool $unserialize [, int $flags = 0 [, int $errorcode ]]]): bool",
	},
	msg_remove_queue: {
	...
	msg_send: {
		...
		signature:
			"( resource $queue , int $msgtype , mixed $message [, bool $serialize [, bool $blocking [, int $errorcode ]]]): bool",
	},
	msg_set_queue: {
	...
	json_decode: {
		...
		signature:
			"( string $json [, bool $assoc [, int $depth = 512 [, int $options = 0 ]]]): mixed",
	},
	json_encode: {
	...
	define: {
		...
		signature:
			"( string $name , mixed $value [, bool $case_insensitive ]): bool",
	},
	defined: {
	...
	iterator_apply: {
		...
		signature:
			"( Traversable $iterator , callable $function [, array $args ]): int",
	},
	iterator_count: {
	...
	spl_autoload_register: {
		...
		signature:
			"([ callable $autoload_function [, bool $throw [, bool $prepend ]]]): bool",
	},
	...
	stream_context_set_option: {
		...
		signature:
			"( resource $stream_or_context , string $wrapper , string $option , mixed $value , array $options ): bool",
	},
	...
	stream_notification_callback: {
		...
		signature:
			"( int $notification_code , int $severity , string $message , int $message_code , int $bytes_transferred , int $bytes_max ): callable",
	},
	...
	http_build_query: {
		...
		signature:
			"( mixed $query_data [, string $numeric_prefix [, string $arg_separator [, int $enc_type ]]]): string",
	},
	parse_url: {
	...
	ftp_append: {
		...
		signature:
			"( resource $ftp , string $remote_file , string $local_file [, int $mode ]): bool",
	},
	ftp_cdup: {
	...
	ftp_rawlist: {
		...
		signature:
			"( resource $ftp_stream , string $directory [, bool $recursive ]): array",
	},
	ftp_rename: {
	...
	dns_get_record: {
		...
		signature:
			"( string $hostname [, int $type = DNS_ANY [, array $authns [, array $addtl [, bool $raw ]]]]): array",
	},
	fsockopen: {
		description: "Open Internet or Unix domain socket connection",
		signature:
	...
	header: {
		...
		signature:
			"( string $header [, bool $replace [, int $http_response_code ]]): void",
	},
	headers_list: {
	...
	setcookie: {
		...
		signature:
			'( string $name [, string $value = "" [, int $expires = 0 [, string $path = "" [, string $domain = "" [, bool $secure [, bool $httponly [, array $options = [] ]]]]]]]): bool',
	},
	setrawcookie: {
	...
	apache_setenv: {
		...
		signature:
			"( string $variable , string $value [, bool $walk_to_top ]): bool",
	},
	getallheaders: {
		description: "Fetch all HTTP request headers",
		signature: "(void): array",
	...
	session_set_cookie_params: {
		...
		signature:
			"( int $lifetime [, string $path [, string $domain [, bool $secure [, bool $httponly , array $options ]]]]): bool",
	},
	session_set_save_handler: {
		description: "Sets user-level session storage functions",
		signature:
			"( callable $open , callable $close , callable $read , callable $write , callable $destroy , callable $gc [, callable $create_sid [, callable $validate_sid [, callable $update_timestamp , object $sessionhandler [, bool $register_shutdown ]]]]): bool",
	},
	session_start: {
	...
	preg_match_all: {
		...
		signature:
			"( string $pattern , string $subject [, array $matches [, int $flags [, int $offset = 0 ]]]): int",
	},
	preg_match: {
	...
	htmlentities: {
		...
		signature:
			'( string $string [, int $flags = ENT_COMPAT | ENT_HTML401 [, string $encoding = ini_get("default_charset") [, bool $double_encode ]]]): string',
	},
	...
	levenshtein: {
		...
		signature:
			"( string $str1 , string $str2 , int $cost_ins , int $cost_rep , int $cost_del ): int",
	},
	localeconv: {
	...
	stristr: {
		...
		signature:
			"( string $haystack , mixed $needle [, bool $before_needle ]): string",
	},
	strlen: {
		description: "Get string length",
		signature: "( string $string ): int",
	...
	strtr: {
		...
		signature:
			"( string $str , string $from , string $to , array $replace_pairs ): string",
	},
	substr_compare: {
		description:
			"Binary safe comparison of two strings from an offset, up to length characters",
		signature:
			"( string $main_str , string $str , int $offset [, int $length [, bool $case_insensitivity ]]): int",
	},
	substr_count: {
		description: "Count the number of substring occurrences",
		signature:
	...
	array_column: {
		...
		signature:
			"( array $input , mixed $column_key [, mixed $index_key ]): array",
	},
	array_combine: {
		description:
	...
	array_multisort: {
		...
		signature:
			"( array $array1 [, mixed $array1_sort_order = SORT_ASC [, mixed $array1_sort_flags = SORT_REGULAR [, mixed $... ]]]): string",
	},
	array_pad: {
	...
	array_reduce: {
		...
		signature:
			"( array $array , callable $callback [, mixed $initial ]): mixed",
	},
	...
	array_slice: {
		...
		signature:
			"( array $array , int $offset [, int $length [, bool $preserve_keys ]]): array",
	},
	array_splice: {
		description:
	...
	array_walk_recursive: {
		...
		signature:
			"( array $array , callable $callback [, mixed $userdata ]): bool",
	},
	array_walk: {
	...
	extract: {
		...
		signature:
			"( array $array [, int $flags = EXTR_OVERWRITE [, string $prefix ]]): int",
	},
	in_array: {
	...
	is_a: {
		...
		signature:
			"( mixed $object , string $class_name [, bool $allow_string ]): bool",
	},
	is_subclass_of: {
		description:
	...
	filter_var_array: {
		...
		signature:
			"( array $data [, mixed $definition [, bool $add_empty ]]): mixed",
	},
	filter_var: {
	...
	is_callable: {
		...
		signature:
			"( mixed $var [, bool $syntax_only [, string $callable_name ]]): bool",
	},
	is_countable: {
	...
	com_print_typeinfo: {
		...
		signature:
			"( object $comobject [, string $dispinterface [, bool $wantsink ]]): bool",
	},
	variant_abs: {
	...
	simplexml_load_file: {
		...
		signature:
			'( string $filename [, string $class_name = "SimpleXMLElement" [, int $options = 0 [, string $ns = "" [, bool $is_prefix ]]]]): SimpleXMLElement',
	},
	simplexml_load_string: {
		description: "Interprets a string of XML into an object",
		signature:
			'( string $data [, string $class_name = "SimpleXMLElement" [, int $options = 0 [, string $ns = "" [, bool $is_prefix ]]]]): SimpleXMLElement',
	},
	utf8_decode: {
		description:
	...
	xmlwriter_start_attribute_ns: {
		...
		signature:
			"( string $prefix , string $name , string $uri , resource $xmlwriter ): bool",
	},
	...
	xmlwriter_start_document: {
		...
		signature:
			"([ string $version = 1.0 [, string $encoding [, string $standalone , resource $xmlwriter ]]]): bool",
	},
	...
	xmlwriter_start_dtd: {
		...
		signature:
			"( string $qualifiedName [, string $publicId [, string $systemId , resource $xmlwriter ]]): bool",
	},
	...
	xmlwriter_write_attribute_ns: {
		...
		signature:
			"( string $prefix , string $name , string $uri , string $content , resource $xmlwriter ): bool",
	},
	...
	xmlwriter_write_dtd_entity: {
		...
		signature:
			"( string $name , string $content , bool $pe , string $pubid , string $sysid , string $ndataid , resource $xmlwriter ): bool",
	},
	xmlwriter_write_dtd: {
		description: "Write full DTD tag",
		signature:
			"( string $name [, string $publicId [, string $systemId [, string $subset , resource $xmlwriter ]]]): bool",
	},
	...
	xmlwriter_write_element: {
		...
		signature:
			"( string $name [, string $content , resource $xmlwriter ]): bool",
	},
	xmlwriter_write_pi: {
		description: "Writes a PI",
		signature:
			"( string $target , string $content , resource $xmlwriter ): bool",
	},
	xmlwriter_write_raw: {
