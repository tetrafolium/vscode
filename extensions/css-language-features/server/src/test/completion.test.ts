...
suite("Completions", () => {
	...
	test("CSS url() Path completion", async function () {
		...
		const folders = [
			{
				name: "x",
				uri: URI.file(path.resolve(import.meta.dirname, "../../test")).toString(
					true,
				),
			},
		];
