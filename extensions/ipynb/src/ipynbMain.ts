...
type OptionsWithCellContentMetadata = vscode.NotebookDocumentContentOptions & {
	cellContentMetadata: { attachments: boolean };
};
...
export function activate(
	...
	const enabled = vscode.workspace
		...
		.get("pasteImagesAsAttachments.enabled", false);
	if (enabled) {
