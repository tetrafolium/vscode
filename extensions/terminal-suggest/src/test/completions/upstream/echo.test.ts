...
const allOptions = ["-E", "-e", "-n"];
const echoExpectedCompletions = [
	{ label: "echo", description: (echoSpec as Fig.Subcommand).description },
];
export const echoTestSuiteSpec: ISuiteSpec = {
	...
	testSpecs: [
		...
		{
			input: "|",
			expectedCompletions: echoExpectedCompletions,
