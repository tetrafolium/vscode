...
const expectedCompletions = [
	{ label: "ls", description: (lsSpec as Fig.Subcommand).description },
];
export const lsTestSuiteSpec: ISuiteSpec = {
	...
	testSpecs: [
		...
		{
			input: "ls -a -|",
			expectedCompletions: allOptions.filter((o) => o !== "-a"),
			expectedResourceRequests: { type: "both", cwd: testPaths.cwd },
		},
