...
suite("Terminal Suggest", () => {
	test("simple command", () => {
		strictEqual(
			getTokenType(
				{ commandLine: "echo", cursorIndex: "echo".length },
				undefined,
			),
			TokenType.Command,
		);
	...
	test("simple argument", () => {
		strictEqual(
			getTokenType(
				{ commandLine: "echo hello", cursorIndex: "echo hello".length },
				undefined,
			),
			TokenType.Argument,
		);
	...
	test("simple command, cursor mid text", () => {
		strictEqual(
			getTokenType(
				{ commandLine: "echo hello", cursorIndex: "echo".length },
				undefined,
			),
			TokenType.Command,
		);
	...
	test("simple argument, cursor mid text", () => {
		strictEqual(
			getTokenType(
				{ commandLine: "echo hello", cursorIndex: "echo hel".length },
				undefined,
			),
			TokenType.Argument,
		);
	...
	suite("pwsh", () => {
		test("simple command", () => {
			strictEqual(
				getTokenType(
					{ commandLine: "Write-Host", cursorIndex: "Write-Host".length },
				...
				getTokenType(
					{
						...
						cursorIndex: "Write-Host hello".length,
					},
					TerminalShellType.PowerShell,
				),
				TokenType.Argument,
		...
		test("reset char", () => {
			strictEqual(
				getTokenType(
					{
						commandLine: `Write-Host hello -and `,
						cursorIndex: `Write-Host hello -and `.length,
					},
					TerminalShellType.PowerShell,
				),
				TokenType.Command,
		...
		test("arguments after reset char", () => {
			strictEqual(
				getTokenType(
					{
						commandLine: `Write-Host hello -and $true `,
						cursorIndex: `Write-Host hello -and $true `.length,
					},
					TerminalShellType.PowerShell,
				),
				TokenType.Argument,
					...
					getTokenType(
						{
							...
							cursorIndex: "echo hello && ech".length,
						},
						undefined,
					),
					TokenType.Command,
			...
			test("multiple commands, cursor mid text", () => {
				strictEqual(
					getTokenType(
						{
							commandLine: "echo hello && echo world",
							cursorIndex: "echo hello && echo w".length,
						},
						undefined,
					),
					TokenType.Argument,
			...
			test("multiple commands, cursor at end with reset char", () => {
				strictEqual(
					getTokenType(
						{
							commandLine: "echo hello && echo world; ",
							cursorIndex: "echo hello && echo world; ".length,
						},
						undefined,
					),
					TokenType.Command,
			...
			test("multiple commands, cursor mid text with reset char", () => {
				strictEqual(
					getTokenType(
						{
							commandLine: "echo hello && echo world; ",
							cursorIndex: "echo hello && echo worl".length,
						},
						undefined,
					),
					TokenType.Argument,
