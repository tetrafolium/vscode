...
/* 		margin: 10px;
	...
	.three {
		...
		return withRandomFileEditor(contents, "css", (editor, doc) => {
			editor.selections = [new Selection(3, 7, 6, 6)];
	...
	.three {
		...
		return withRandomFileEditor(contents, "css", (editor, doc) => {
			editor.selections = [new Selection(3, 0, 6, 6)];
	...
	.three {
		...
		return withRandomFileEditor(contents, "css", (editor, doc) => {
			editor.selections = [new Selection(3, 7, 7, 0)];
	...
	.three {
		...
		return withRandomFileEditor(contents, "css", (editor, doc) => {
			editor.selections = [new Selection(3, 0, 7, 0)];
