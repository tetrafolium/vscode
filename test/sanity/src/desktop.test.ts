...
export function setup(context: TestContext) {
	...
	context.test(
		"desktop-linux-deb-armhf",
		["linux", "arm32", "deb", "desktop"],
		async () => {
	...
	context.test(
		"desktop-linux-rpm-armhf",
		["linux", "arm32", "rpm", "desktop"],
		async () => {
	...
	context.test(
		"desktop-linux-snap-x64",
		["linux", "x64", "snap", "desktop"],
		async () => {
