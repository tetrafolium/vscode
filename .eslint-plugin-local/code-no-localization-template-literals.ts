 ...
 */
export default new (class NoLocalizationTemplateLiterals
	implements eslint.Rule.RuleModule
{
	readonly meta: eslint.Rule.RuleMetaData = {
		messages: {
			noTemplateLiteral:
				"Template literals cannot be used in localization calls. Use placeholders like {0}, {1} instead.",
		},
		docs: {
			description:
				"Prevents template literals in vscode.l10n.t() and nls.localize() calls",
		},
		schema: false,
	};
			...
			if (callee.type === "MemberExpression") {
				...
				if (object.type === "MemberExpression") {
					...
					if (
						...
						outerObject.name === "vscode" &&
						outerProperty.type === "Identifier" &&
						outerProperty.name === "l10n" &&
